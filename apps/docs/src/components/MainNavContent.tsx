  ...
  return (
    <>
      ...
      <VStack alignItems="flex-start" spacing="$1" mb="$6">
        ...
        <AppNavLink href="/docs/features/create-styles">
          Create styles
        </AppNavLink>
        <AppNavLink href="/docs/features/responsive-styles">
          Responsive styles
        </AppNavLink>
        <AppNavLink href="/docs/features/global-styles">
          Global styles
        </AppNavLink>
        <AppNavLink href="/docs/features/incmix-factory">
          Hope factory
        </AppNavLink>
      </VStack>
      <MainNavSubtitle mb="$2">Theming</MainNavSubtitle>
      <VStack alignItems="flex-start" spacing="$1" mb="$6">
        <AppNavLink href="/docs/theming/default-theme">
          Default theme
        </AppNavLink>
        <AppNavLink href="/docs/theming/customize-theme">
          Customize theme
        </AppNavLink>
        <AppNavLink href="/docs/theming/css-variables">
          CSS variables
        </AppNavLink>
      ...
      <VStack alignItems="flex-start" spacing="$1" mb="$6">
        ...
        <AppNavLink href="/docs/data-entry/form-control">
          FormControl
        </AppNavLink>
      ...
      <VStack alignItems="flex-start" spacing="$1" mb="$6">
        ...
        <AppNavLink href="/docs/data-display/file-viewer">
          FileViewer
        </AppNavLink>
        ...
        <AppNavLink href="/docs/data-display/data-table">Data Table</AppNavLink>
        <AppNavLink href="/docs/data-display/tag">Tag</AppNavLink>
        <AppNavLink href="/docs/data-display/tree-view">TreeView</AppNavLink>
      ...
      <VStack alignItems="flex-start" spacing="$1" mb="$6">
        ...
        <AppNavLink href="/docs/feedback/circular-progress">
          CircularProgress
        </AppNavLink>
      ...
      <VStack alignItems="flex-start" spacing="$1">
        ...
        <AppNavLink href="/docs/others/google-maps">GoogleMaps</AppNavLink>
      </VStack>
    </>
  );
}
