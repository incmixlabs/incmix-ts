...
export default function CSSVariables() {
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        All Hope UI theme tokens are available as CSS custom properties (aka CSS
        variables) with the <Code>incmix</Code> prefix.
      </Text>
      <Text mb="$5">
        Let's say you want to change your application <Code>#root</Code> div{" "}
        <Code>background-color</Code> using a color from the Hope UI theme. In a
        plain CSS file you can do it like this:
      </Text>
