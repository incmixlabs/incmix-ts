...
const marginPadding = `import { Box } from "@incmix/ui"
...
const colors = `import { Box } from "@incmix/ui"
...
const typography = `import { Text } from "@incmix/ui"
...
const layout = `import { Box } from "@incmix/ui"
...
const size = `import { Box } from "@incmix/ui"
...
const flexbox = `import { Box, Flex } from "@incmix/ui"
...
const grid = `import { Box, Grid } from "@incmix/ui"
...
const borders = `import { Box } from "@incmix/ui"

<Box border="1px" borderColor="$neutral6">
  Card
</Box>`;

const borderRadius = `import { Button } from "@incmix/ui"
...
const position = `import { Box } from "@incmix/ui"
...
const shadow = `import { Box } from "@incmix/ui"
...
const pseudo = `import { Button } from "@incmix/ui"
