import { Alert, AlertDescription, Button, Text } from "@incmix/ui";
...
import {
  StylePropsTable,
  StylePropsTableItem,
} from "@/components/StylePropsTable";
...
const marginPaddingProps: StylePropsTableItem[] = [
  ...
  {
    prop: "px",
    cssProperty: "padding-inline-start + padding-inline-end",
    themeToken: "space",
  },
  {
    prop: "py",
...
const gridProps: StylePropsTableItem[] = [
  ...
  {
    prop: "gridTemplateColumns, *templateColumns",
    cssProperty: "grid-template-columns",
  },
  {
    prop: "gridTemplateRows, *templateRows",
    cssProperty: "grid-template-rows",
  },
  {
    prop: "gridTemplateAreas, *templateAreas",
...
const pseudoProps: StylePropsTableItem[] = [
  ...
  {
    prop: "_disabled",
    cssProperty: "&[disabled], &[aria-disabled=true], &[data-disabled]",
  },
  {
    prop: "_readOnly",
    cssProperty: "&[aria-readonly=true], &[readonly], &[data-readonly]",
  },
  ...
  },
  {
    ...
    cssProperty:
      "[role=group]:focus-within &, [data-group]:focus-within &, .group:focus-within &",
  },
  {
    prop: "_peerFocusWithin",
    cssProperty: "[data-peer]:focus-within ~ &, .peer:focus-within ~ &",
  },
  {
    prop: "_peerPlaceholderShown",
    cssProperty:
      "[data-peer]:placeholder-shown ~ &, .peer:placeholder-shown ~ &",
  },
  ...
  {
    prop: "_mediaReduceMotion",
    cssProperty: "@media (prefers-reduced-motion: reduce)",
  },
  { prop: "_dark", cssProperty: ".incmix-ui-dark &" },
  { prop: "_light", cssProperty: ".incmix-ui-light &" },
];
...
export default function StyleProps() {
  ...
  return (
    ...
    >
      ...
      <Text mb="$6">
        Style props are a way to alter the style of a component by simply
        passing props to it. It helps to save time by providing helpful
        shorthand ways to style components.
      </Text>
      <SectionTitle>Reference</SectionTitle>
      <Text mb="$5">
        The following table shows a list of every style prop and the properties
        within each group.
      </Text>
      ...
      <Alert status="warning" mb="$8">
        <AlertDescription>
          Props marked with an <Code>*</Code> will only work if you use the{" "}
          <Code>Flex</Code> or <Code>Stack</Code> components.
        </AlertDescription>
      </Alert>
      ...
      <Alert status="warning" mb="$8">
        <AlertDescription>
          Props marked with an <Code>*</Code> will only work if you use the{" "}
          <Code>Grid</Code> and <Code>GridItem</Code> components.
        </AlertDescription>
      </Alert>
      ...
      <Text mb="$5">
        All Hope UI components are polymorphic, meaning you can use the{" "}
        <Code>as</Code> prop to change the rendered element.
      </Text>
      <Text mb="$5">
        For example, say you are using a <Code>Button</Code> component, and you
        need to make it a link instead. You can compose <Code>a</Code> and{" "}
        <Code>Button</Code> like this:
      </Text>
      ...
      <Text>
        If you are using TypeScript you will get proper auto-completion based on
        the value of the <Code>as</Code> prop.
      </Text>
    </PageLayout>
  );
}
