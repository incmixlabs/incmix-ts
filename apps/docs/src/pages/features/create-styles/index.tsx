  ...
  return (
    ...
    >
      ...
      <Text mb="$8">
        ...
        css-in-js libary. Meaning you can use all tools available in stitches to
        create styles in Hope UI.
      </Text>
      <SectionTitle id="the-css-function">
        The <Code>css</Code> function
      </SectionTitle>
      <Text mb="$5">
        Hope UI expose the <Code>css</Code> function from{" "}
        <Code>@stitches/core</Code> configured with the Hope UI theme.
      </Text>
      <CodeSnippet snippet={snippets.importCssFunction} mb="$8" />
      <Text mb="$5">
        If you don't like the style props API or your HTML is comming too
        verbose the css function is a great way to extract your styles plus you
        get the full power of the stitches API.
      </Text>
