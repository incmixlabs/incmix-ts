...
export default function ResponsiveStyles() {
  ...
  const contextualNavLinks: ContextualNavLink[] = [
    ...
    {
      href: "#usage-with-css-function",
      label: "Usage with stitches `css` function",
    },
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        Hope UI supports responsive styles out of the box. Instead of manually
        adding <Code>@media</Code> queries and adding nested styles throughout
        your code, Hope UI allows you to use an object syntax to add
        mobile-first responsive styles.
      </Text>
      <Alert status="info" mb="$5">
        <AlertDescription>
          Hope UI use the <Code>@media(min-width)</Code> media query to ensure
          your interfaces are mobile-first.
        </AlertDescription>
      </Alert>
      <Text mb="$5">
        Responsive syntax relies on the following breakpoints defined in the
        Hope UI theme:
      </Text>
      <incmix.div overflowX="auto" mb="$8">
        <Table dense>
          <Thead bg="$neutral2">
            <Tr>
              <Th>Name</Th>
      ...
      <Alert status="warning" mb="$8">
        <AlertDescription>
          Breakpoints are created during the <Code>createStitches</Code> call
          which occurs internally in Hope UI, for this reason it is currently
          not possible to customize breakpoint values.
        </AlertDescription>
      </Alert>
      <SectionTitle id="the-object-syntax">The object syntax</SectionTitle>
      <Text mb="$4">
        All style props accept an object as value for mobile-first responsive
        styles.
      </Text>
      <Text mb="$5">
      ...
      <Text mb="$5">
        To make the width responsive here's what you need to do:
      </Text>
      ...
      <Text mb="$5">
        When using responsive styles with the <Code>css</Code> prop you don't
        need the <Code>@initial</Code> breakpoint. It's like the normal way of
        creating mobile-first responsive styles in CSS.
      </Text>
      ...
      <Text mb="$5">
        Like style props, variant created with stitches <Code>css</Code>{" "}
        function support responsive styles.
      </Text>
      ...
      <Text mb="$5">
        Here's a simple example of a marketing page component that uses a
        stacked layout on small screens, and a side-by-side layout on larger
        screens <strong>(resize your browser to see it in action):</strong>
      </Text>
