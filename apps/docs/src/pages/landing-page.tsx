  ...
  return (
    ...
    >
      ...
      <Text
        ...
        mb="$8"
      >
        Hope UI is a composable and accessible component library that gives you
        the foundation to build your next SolidJS application.
      </Text>
      <Stack
...
function FeatureSection(props: HTMLIncmixProps<"div">) {
  return (
    <Box minH="calc(100vh - 72px)" bg="$neutral2" {...props}>
      <Container>
        <VStack
          mx={{ "@initial": "$4", "@xl": "auto" }}
          py={{ "@initial": "$10", "@sm": "$20" }}
        >
          <Heading
            level={2}
          ...
          <Text
            ...
            mb={{ "@initial": "$14", "@sm": "$20" }}
          >
            Hope UI provides the foundation for building your application's user
            interface, giving you the ability to focus on what really matter for
            your users.
          </Text>
          <SimpleGrid
          ...
          >
            ...
            >
              ...
              <Text color="$neutral11">
                Start your project with over 40 well designed SolidJS
                components.
              </Text>
            </GridItem>
            <GridItem
            ...
            >
              ...
              <Text color="$neutral11">
                Use Hope UI's design system or build your own using the theming
                features.
              </Text>
            </GridItem>
            <GridItem
            ...
            >
              ...
              <Text color="$neutral11">
                Add dark mode support to your app with just a few lines of code.
            ...
            >
              ...
              <Text color="$neutral11">
                An intuitive and familiar API that help you speed up your
                development.
              </Text>
            </GridItem>
          </SimpleGrid>
