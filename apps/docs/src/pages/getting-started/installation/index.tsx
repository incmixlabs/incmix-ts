...
export default function Installation() {
  ...
  return (
    <PageLayout nextLink={nextLink} contextualNavLinks={contextualNavLinks}>
      ...
      <Text mb="$5">
        Inside your SolidJS project, install Hope UI by running either of the
        following:
      </Text>
      ...
      <Text mb="$5">
        After installing Hope UI, you need to set up the{" "}
        <Code>ThemeProvider</Code> at the root of your application. This can be
        either in your <Code>index.jsx</Code> or <Code>index.tsx</Code>
      </Text>
      ...
      <Text mb="$3">
        If you intend to customise the default theme to match your design
        requirements, you can extend the <Code>theme</Code> from{" "}
        <Code>@incmix/ui</Code>.
      </Text>
      <Text mb="$5">
        The ThemeProvider accept a <Code>config</Code> prop that deep merges the
        default theme with your customizations.
      </Text>
