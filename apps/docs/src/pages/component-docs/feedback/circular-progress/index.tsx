...
export default function CircularProgressDoc() {
  ...
  const contextualNavLinks: ContextualNavLink[] = [
    ...
    {
      href: "#with-round-cap",
      label: "CircularProgress with round cap",
      indent: true,
    },
    ...
    {
      href: "#circular-progress-props",
      label: "CircularProgress props",
      indent: true,
    },
    {
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        The <Code>CircularProgress</Code> component is used to indicate the
      ...
      <UnorderedList spacing="$2" mb="$12">
        <ListItem>
          <strong>CircularProgress:</strong> The wrapper that provides context
          for its children.
        </ListItem>
        <ListItem>
          <strong>CircularProgressIndicator:</strong> The visual indicator of
          the progress.
        </ListItem>
        <ListItem>
          <strong>CircularProgressLabel:</strong> The textual representation of
          the progress.
        </ListItem>
      </UnorderedList>
      ...
      <Text mb="$5">
        ...
        <Code>CircularProgressIndicator</Code> and the <Code>trackColor</Code>{" "}
        prop to change the color of the progress track (background).
      </Text>
      ...
      <SectionSubtitle id="thickness">
        CircularProgress thickness
      </SectionSubtitle>
      <Text mb="$5">
        Use the <Code>thickness</Code> prop to change the thickness of the
        progress.
      </Text>
      ...
      <SectionSubtitle id="with-round-cap">
        CircularProgress with round cap
      </SectionSubtitle>
      <Text mb="$5">
        Use the <Code>withRoundCaps</Code> prop to set the{" "}
        <Code>CircularProgressIndicator</Code> caps rounded.
      </Text>
      ...
      <SectionSubtitle id="with-label">
        CircularProgress with label
      </SectionSubtitle>
      <Text mb="$5">
        You can set a label inside the propgress by using the{" "}
        <Code>CircularProgressLabel</Code> component. By default it will display
      ...
      <SectionSubtitle id="indeterminate">
        Indeterminate progress
      </SectionSubtitle>
      <Text mb="$5">
        Use the <Code>indeterminate</Code> prop to set the progress in an
        indeterminate state.
      </Text>
      ...
      <UnorderedList spacing="$2" mb="$12">
        <ListItem>
          <Code>CircularProgress</Code> has a <Code>role</Code> set to{" "}
          <Code>progressbar</Code> to denote that it is a progress.
        </ListItem>
        <ListItem>
          <Code>CircularProgress</Code> has <Code>aria-valuenow</Code> set to
          the percentage completion value passed to the component, to ensure the
          progress percent is visible to screen readers.
        </ListItem>
      </UnorderedList>
      <SectionTitle id="theming">Theming</SectionTitle>
      <Text mb="$5">
        <Code>CircularProgress</Code> base styles and default props can be
        overridden in the Hope UI theme configuration like below:
      </Text>
      <CodeSnippet lang="js" snippet={snippets.theming} mb="$12" />
      <SectionTitle id="props">Props</SectionTitle>
      <SectionSubtitle id="circular-progress-props">
