import { HStack, Spinner, Text } from "@incmix/ui";
...
export default function SpinnerDoc() {
  ...
  const contextualNavLinks: ContextualNavLink[] = [
    ...
    {
      href: "#empty-area-color",
      label: "Spinner empty area color",
      indent: true,
    },
  ...
  return (
    ...
    >
      ...
      <SectionSubtitle id="empty-area-color">
        Spinner empty area color
      </SectionSubtitle>
      <Text mb="$5">
        Use the <Code>emptyColor</Code> prop to change the background color of
        the Spinner.
      </Text>
      ...
      <Text mb="$5">
        <Code>Spinner</Code> base styles and default props can be overridden in
