...
export default function SkeletonDoc() {
  ...
  const contextualNavLinks: ContextualNavLink[] = [
    ...
    {
      href: "#circle-and-text",
      label: "Circle and text Skeleton",
      indent: true,
    },
    ...
    {
      href: "#skeleton-circle-props",
      label: "SkeletonCircle props",
      indent: true,
    },
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        <Code>Skeleton</Code> is used to display the loading state of some
        components.
      </Text>
      ...
      <UnorderedList spacing="$2" mb="$12">
        <ListItem>
          <strong>Skeleton:</strong> The base component that show the loading
          state.
        </ListItem>
        <ListItem>
        ...
        <ListItem>
          <strong>SkeletonText:</strong> A skeleton that represents one or more
          lines of text.
        </ListItem>
      </UnorderedList>
      ...
      <SectionSubtitle id="circle-and-text">
      ...
      <Text mb="$5">
        Use the <Code>startColor</Code> and <Code>endColor</Code> props to
      ...
      <SectionSubtitle id="skeleton-circle-props">
        SkeletonCircle props
      </SectionSubtitle>
      <PropsTable items={skeletonCirclePropItems} mb="$10" />
      <SectionSubtitle id="skeleton-text-props">
        SkeletonText props
      </SectionSubtitle>
