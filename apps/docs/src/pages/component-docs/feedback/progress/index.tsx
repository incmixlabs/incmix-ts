...
export default function ProgressDoc() {
  ...
  const contextualNavLinks: ContextualNavLink[] = [
    ...
    {
      href: "#progress-indicator-props",
      label: "ProgressIndicator props",
      indent: true,
    },
  ];
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        <Code>Progress</Code> is used to display the progress status for a task
      ...
      <UnorderedList spacing="$2" mb="$12">
        <ListItem>
          <strong>Progress:</strong> The wrapper that provides context for its
          children.
        </ListItem>
        <ListItem>
          <strong>ProgressIndicator:</strong> The visual indicator of the
          progress.
        </ListItem>
        <ListItem>
          <strong>ProgressLabel:</strong> The textual representation of the
          progress.
        </ListItem>
      </UnorderedList>
      ...
      <Text mb="$5">
        ...
        <Code>ProgressIndicator</Code> and the <Code>trackColor</Code> prop to
        change the color of the progress track (background).
      </Text>
      ...
      <Text mb="$2">
        Use the <Code>size</Code> prop to change the size of the Progress. You
        can set the value to <Code>xs</Code>, <Code>sm</Code>, <Code>md</Code>{" "}
        or <Code>lg</Code>.
      </Text>
      <Text mb="$5">
      ...
      <Text mb="$5">
        ...
        <Code>ProgressLabel</Code> component. By default it will display the
        progress percentage.
      </Text>
      ...
      <Text mb="$5">
        Use the <Code>striped</Code> prop to apply stripes on the{" "}
      ...
      <UnorderedList spacing="$2" mb="$12">
        <ListItem>
          <Code>Progress</Code> has a <Code>role</Code> set to{" "}
          <Code>progressbar</Code> to denote that it is a progress.
        </ListItem>
        <ListItem>
          <Code>Progress</Code> has <Code>aria-valuenow</Code> set to the
          percentage completion value passed to the component, to ensure the
          progress percent is visible to screen readers.
        </ListItem>
      </UnorderedList>
      <SectionTitle id="theming">Theming</SectionTitle>
      <Text mb="$5">
        <Code>Progress</Code> base styles and default props can be overridden in
      ...
      <SectionSubtitle id="progress-indicator-props">
