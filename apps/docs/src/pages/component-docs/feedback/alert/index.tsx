...
export default function AlertDoc() {
  ...
  const contextualNavLinks: ContextualNavLink[] = [
    ...
    {
      href: "#alert-description-props",
      label: "AlertDescription props",
      indent: true,
    },
  ];
  ...
  const propItems: PropsTableItem[] = [
    ...
    },
    {
      name: "status",
      description:
        "The status of the alert. This affects the color scheme and icon used.",
  ...
  return (
    ...
    >
      ...
      <UnorderedList spacing="$2" mb="$12">
        ...
        <ListItem>
          <strong>AlertIcon:</strong> The visual icon for the alert that changes
          based on the <Code>status</Code> prop.
        </ListItem>
        <ListItem>
          <strong>AlertTitle:</strong> The title of the alert to be announced by
          screen readers.
        </ListItem>
        <ListItem>
          <strong>AlertDescription:</strong> The description of the alert to be
      ...
      <Preview snippet={snippets.basicUsage} mb="$10">
        <Alert status="danger">
          ...
          <AlertDescription>
            Your Hope UI experience may be degraded.
          </AlertDescription>
      ...
      <Text mb="$5">
        Use the <Code>status</Code> prop to change the status of the alert. This
        affects the color scheme and icon used. You can set the value to{" "}
      ...
      <Text mb="$5">
        ...
        Alert You can set the value to <Code>solid</Code>, <Code>subtle</Code>,{" "}
        <Code>left-accent</Code> or <Code>top-accent</Code>.
      </Text>
      ...
      <Text mb="$5">
        <Code>Alert</Code> ships with smaller components to allow for
        flexibility in creating all kinds of layouts. Here's an example of a
        custom alert style and layout:
      </Text>
      ...
      <Text mb="$5">
        <Code>Alert</Code> can also incorporate other Hope UI components. Here's
        an example of an alert with wrapping description text:
      </Text>
      ...
      <Text mb="$5">
        <Code>Alert</Code> base styles and default props can be overridden in
      ...
      <Text mb="$10">
        <Code>AlertIcon</Code> composes <Code>Icon</Code> and changes the icon
        based on the <Code>status</Code> prop. You can use the <Code>as</Code>{" "}
        prop to render a custom icon.
      </Text>
      ...
      <SectionSubtitle id="alert-description-props">
