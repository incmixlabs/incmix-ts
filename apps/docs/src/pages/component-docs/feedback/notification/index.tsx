...
export default function SpinnerDoc() {
  ...
  const contextualNavLinks: ContextualNavLink[] = [
    ...
    {
      href: "#notification-placement",
      label: "Notification placement",
      indent: true,
    },
    {
      href: "#notification-duration",
      label: "Notification duration",
      indent: true,
    },
    {
      href: "#persistent-notification",
      label: "Persistent notification",
      indent: true,
    },
    {
      href: "#using-custom-component",
      label: "Using custom component",
      indent: true,
    },
    {
      href: "#updating-notification",
      label: "Updating notification",
      indent: true,
    },
    {
      href: "#hidding-notification",
      label: "Hidding notification",
      indent: true,
    },
    ...
    {
      href: "#notifications-provider-props",
      label: "NotificationsProvider props",
      indent: true,
    },
  ...
  const notificationPropItems: PropsTableItem[] = [
    {
      name: "status",
      description:
        "The status of the notification. This affects the color scheme and icon used.",
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        Notification give feedback to users after an action has taken place.
      </Text>
      <SectionTitle id="import">Import</SectionTitle>
      <CodeSnippet snippet={snippets.importComponent} mb="$6" />
      <UnorderedList spacing="$2" mb="$12">
        <ListItem>
          <strong>NotificationsProvider:</strong> The component that provides
          the notification system.
        </ListItem>
        <ListItem>
          <strong>Notification:</strong> The wrapper for notification
          components.
        </ListItem>
        <ListItem>
          <strong>NotificationIcon:</strong> The visual icon for the
          notification that changes based on the <Code>status</Code> prop.
        </ListItem>
        <ListItem>
          <strong>NotificationTitle:</strong> The title of the notification.
        </ListItem>
        <ListItem>
          <strong>NotificationDescription:</strong> The description of the
          notification.
        </ListItem>
        <ListItem>
          <strong>notificationService:</strong> An utility object used to
      ...
      <Text mb="$5">
        Then use the <Code>notificationService</Code> anywhere in your
        application:
      </Text>
      ...
      <Text mb="$3">
        The notification system is based on custom events, Hope UI exports the
        following methods through the <Code>notificationService</Code> object:
      </Text>
      <UnorderedList spacing="$2" mb="$10">
        <ListItem>
          <strong>show:</strong> adds given notification to notifications list
          or queue depending on current state and limit.
        </ListItem>
        <ListItem>
          <strong>update:</strong> updates notification that was previously
          added to the state or queue.
        </ListItem>
        <ListItem>
          <strong>hide:</strong> removes notification with given id from
          notifications state and queue.
        </ListItem>
        <ListItem>
          <strong>clear:</strong> removes all notifications from notifications
          state and queue.
        </ListItem>
        <ListItem>
      ...
      <SectionSubtitle id="notification-status">
        Notification status
      </SectionSubtitle>
      <Text mb="$5">
        Use the <Code>status</Code> parameter to change the status of the
        notification, this affects the icon used. You can set the value to{" "}
        <Code>success</Code>, <Code>info</Code>, <Code>warning</Code> or{" "}
        <Code>danger</Code>.
      </Text>
      ...
      <SectionSubtitle id="notification-placement">
        Notification placement
      </SectionSubtitle>
      <Text mb="$5">
        <Code>NotificationsProvider</Code> renders notifications with fixed
        position inside a Portal. Position cannot be changed per notification.
        Use the <Code>placement</Code> prop to define the placement. You can set
        the value to <Code>top-start</Code>, <Code>top</Code>,{" "}
      ...
      <SectionSubtitle id="notification-duration">
        Notification duration
      </SectionSubtitle>
      <Text mb="$5">
        Use the <Code>duration</Code> parameter to change the duration of the
        notification. By default, notitification will dismiss after 5 seconds.
      </Text>
      ...
      <SectionSubtitle id="persistent-notification">
        Persistent notification
      </SectionSubtitle>
      <Text mb="$5">
        Use the <Code>persistent</Code> parameter to make the notification
        persistent. the duration will be ignored.
      </Text>
      ...
      <SectionSubtitle id="using-custom-component">
        Using custom component
      </SectionSubtitle>
      <Text mb="$5">
        Use the <Code>render</Code> parameter to display a custom component
        instead of the default Hope UI <Code>Notification</Code>.
      </Text>
      ...
      <SectionSubtitle id="updating-notification">
        Updating notification
      </SectionSubtitle>
      <Text mb="$5">
        Use the <Code>update</Code> method to update a specific notification.
        This method takes the same parameters as the <Code>show</Code> method
      ...
      <SectionSubtitle id="hidding-notification">
        Hidding notification
      </SectionSubtitle>
      <Text mb="$5">
        Use the <Code>hide</Code> method to dismiss a specific notification by
        passing its notification id.
      </Text>
          ...
          <Button
            onClick={() =>
              notificationService.show({
                ...
                description:
                  "Hey, you can't hide me...unless using the 'Hide' button",
                persistent: true,
                closable: false,
              })
            }
      ...
      <Text mb="$5">
        <Code>NotificationsProvider</Code> uses a queue to manage its state. You
        can limit maximum amount of notifications that can be displayed by
        setting the <Code>limit</Code> prop.
      </Text>
      ...
      <Text mb="$5">
        You can use the <Code>clearQueue</Code> method to remove all
        notifications that are not currently displayed and the{" "}
        <Code>clear</Code> method to remove all notifications from state and
        queue.
      </Text>
      ...
      <Text mb="$5">
        <Code>Notification</Code> base styles and default props can be
        overridden in the Hope UI theme configuration like below:
      </Text>
      ...
      <SectionSubtitle id="notification-props">
        Notification props
      </SectionSubtitle>
      ...
      <Text mb="$10">
        The <Code>update</Code> method takes the same parameters as the{" "}
        <Code>show</Code> method except that <Code>id</Code> is required.
      </Text>
