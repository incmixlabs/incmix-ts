import { CloseButton, HStack, Text } from "@incmix/ui";
...
export default function CloseButtonDoc() {
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        <Code>CloseButton</Code> is essentially a button with a close icon. It
        is used to handle the close functionality in feedback and overlay
        components like Alerts, Notifications, Drawers and Modals.
      </Text>
      ...
      <Text mb="$5">
        Use the <Code>size</Code> prop to change the size of the CloseButton.
        You can set the value to <Code>sm</Code>, <Code>md</Code> or{" "}
        <Code>lg</Code>.
      </Text>
      ...
      <Text mb="$5">
        <Code>CloseButton</Code> base styles and default props can be overridden
