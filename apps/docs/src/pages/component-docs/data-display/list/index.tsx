...
export default function ListDoc() {
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        <Code>List</Code> component is used to display list items. It renders a{" "}
      ...
      <Text mb="$5">
        Add icons to the list items by using the <Code>ListIcon</Code>{" "}
        component. The size of the icon is relative to the font size of the list
        item.
      </Text>
