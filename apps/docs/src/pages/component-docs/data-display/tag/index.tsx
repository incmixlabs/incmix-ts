...
export default function TagDoc() {
  ...
  const contextualNavLinks: ContextualNavLink[] = [
    ...
    {
      href: "#with-close-button",
      label: "Tag with close button",
      indent: true,
    },
  ...
  const propItems: PropsTableItem[] = [
    ...
    },
    {
      name: "dotPlacement",
      description:
        "Determines the placement of the dot when `variant` is `dot`.",
      type: '"start" | "end"',
      defaultValue: '"start"',
    },
  ];
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        <Code>Tag</Code> component is used for items that need to be labeled,
      ...
      <incmix.ul ps="$6" mb="$12">
        ...
        <incmix.li mb="$2">
          <strong>TagLeftIcon:</strong> The icon placed on the left side of the
          tag.
        </incmix.li>
        <incmix.li mb="$2">
          <strong>TagRightIcon:</strong> The icon placed on the right side of
          the tag.
        </incmix.li>
        <incmix.li>
      ...
      <Text mb="$5">
        Use the <Code>colorScheme</Code> prop to change the color of the Tag You
        can set the value to <Code>primary</Code>, <Code>accent</Code>,{" "}
      ...
      <Text mb="$5">
        Use the <Code>size</Code> prop to change the size of the Tag You can set
        the value to <Code>sm</Code>, <Code>md</Code> or <Code>lg</Code>.
      </Text>
      ...
      <Text mb="$5">
        Use the <Code>variant</Code> prop to change the visual style of the Tag
        You can set the value to <Code>solid</Code>, <Code>subtle</Code>,{" "}
        <Code>outline</Code> or <Code>dot</Code>.
      </Text>
      ...
      <Text mb="$5">
        You can add left and right icons to the Tag component using the{" "}
        <Code>TagLeftIcon</Code> and <Code>TagRightIcon</Code> components
        respectively.
      </Text>
      ...
      <SectionSubtitle id="with-close-button">
        Tag with close button
      </SectionSubtitle>
      <Text mb="$5">
        Use the <Code>TagCloseButton</Code> component to add a close button to
        the Tag
      </Text>
      ...
      <Text mb="$5">
        <Code>Tag</Code> base styles and default props can be overridden in the
