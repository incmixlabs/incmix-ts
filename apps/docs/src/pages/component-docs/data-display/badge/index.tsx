import { Badge, HStack, Text } from "@incmix/ui";
...
export default function BadgeDoc() {
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        Use the <Code>colorScheme</Code> prop to change the color of the Badge.
      ...
      <Text mb="$5">
        ...
        Badge. You can set the value to <Code>solid</Code>, <Code>subtle</Code>{" "}
        or <Code>outline</Code>.
      </Text>
      ...
      <Text mb="$5">
        <Code>Badge</Code> base styles and default props can be overridden in
