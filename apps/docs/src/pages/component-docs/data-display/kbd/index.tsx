import { Kbd, ListItem, Text, UnorderedList } from "@incmix/ui";
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        ...
        keys performs a given action. The action itself should be further
        explained in accompanying content. It renders a <Code>kbd</Code>{" "}
        element.
      </Text>
      ...
      <Text mb="$5">
        ...
        indicate that a combination of keys will activate the shortcut.
      </Text>
      ...
      <Text mb="$5">
        For a sequence of keys where one must follow the other, write{" "}
        <em>"then"</em> in between. Stick to lowercase to match the non-letter
        keys.
      </Text>
      ...
      <Text mb="$5">
        If two different keys can execute the same action or the shortcut itself
        may look different on the user’s keyboard, write <em>"or"</em> in
        between.
      </Text>
