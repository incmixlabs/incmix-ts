...
export default function TableDoc() {
  ...
  const nextLink: ContextualNavLink = {
    href: "/docs/data-display/data-table",
    label: "Data Table",
  };
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        ...
        <Code>table</Code> element by default.
      </Text>
      ...
      <Text mb="$5">
        Use the <Code>striped</Code> prop to render striped rows. You can set
        the value to <Code>even</Code> or <Code>odd</Code>.
      </Text>
      ...
      <Text mb="$5">
        <Code>Table</Code> base styles and default props can be overridden in
      ...
      <SectionSubtitle id="table-caption-props">
        TableCaption props
      </SectionSubtitle>
