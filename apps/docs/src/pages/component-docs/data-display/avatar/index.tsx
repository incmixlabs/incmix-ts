  ...
  return (
    ...
    >
      ...
      <UnorderedList spacing="$2" mb="$12">
        ...
        <ListItem>
          <strong>AvatarBadge:</strong> A wrapper that displays its content on
          the right corner of the avatar.
        </ListItem>
        <ListItem>
          <strong>AvatarGroup:</strong> A wrapper to stack multiple Avatars
          together.
        </ListItem>
        <ListItem>
          <strong>AvatarExcess:</strong> The number of non-displayed avatars in
          a group.
        </ListItem>
      </UnorderedList>
      ...
      <Text mb="$5">
        Use the <Code>size</Code> prop to change the size of the Avatar. You can
        set the value to <Code>2xs</Code>, <Code>xs</Code>, <Code>sm</Code>,{" "}
        <Code>md</Code>, <Code>lg</Code>, <Code>xl</Code> or <Code>2xl</Code>.
      </Text>
      <Preview snippet={snippets.sizes} mb="$10">
        <HStack alignItems="flex-start" wrap="wrap" spacing="$4">
          ...
          <Avatar
            size="xs"
            name="Isabella Mckinney"
            src="https://bit.ly/3tRVozX"
          />
          <Avatar
            size="sm"
      ...
      <Text mb="$2">
        If there is an error loading the <Code>src</Code> of the avatar, there
        are 2 fallbacks:
      </Text>
      <incmix.ul ps="$6" mb="$5">
        <incmix.li mb="$2">
          If there's a <Code>name</Code> prop, we use it to generate the
          initials.
        </incmix.li>
        <incmix.li>
      ...
      <SectionSubtitle id="custom-fallback">
        Customize the fallback avatar
      </SectionSubtitle>
      <Text mb="$2">
        You can customize the background color and icon of the fallback avatar
        icon to match your design requirements.
      </Text>
      <incmix.ul ps="$6" mb="$5">
        <incmix.li mb="$2">
      ...
      <Alert status="warning" mb="$10">
        <AlertDescription>
          <Code>icon</Code> is a render prop that provides proper{" "}
          <Code>role</Code> and <Code>aria-label</Code> attributes to use in
          your custom icon.
        </AlertDescription>
      </Alert>
      <SectionSubtitle id="with-badge">Avatar with badge</SectionSubtitle>
      <Text mb="$5">
        In some products, you might need to show a badge on the right corner of
        the avatar. We call this a <strong>badge</strong>. Here's an example
      ...
      <Alert status="warning" mb="$10">
        <AlertDescription>
          Note the use of <Code>em</Code> for the size of the{" "}
          <Code>AvatarBadge</Code>. This is useful to size the badge relative to
          the avatar font size.
        </AlertDescription>
      </Alert>
      ...
      <Text mb="$2">
        ...
        <Code>AvatarGroup</Code> component.
      </Text>
      <incmix.ul ps="$6" mb="$5">
        <incmix.li mb="$2">
        ...
        <incmix.li>
          To set a remaining avatars number, use the <Code>AvatarExcess</Code>{" "}
          component.
        </incmix.li>
      </incmix.ul>
      ...
      <SectionSubtitle id="change-initials-logic">
        Changing the initials logic
      </SectionSubtitle>
      <Text mb="$12">
        Use the <Code>getInitials</Code> prop to manage how initials are
        generated from name. By default Hope UI merge the first characters of
        each word in the <Code>name</Code> prop.
      </Text>
      <SectionTitle id="theming">Theming</SectionTitle>
      <Text mb="$5">
        <Code>Avatar</Code> base styles and default props can be overridden in
      ...
      <SectionSubtitle id="avatar-group-props">
        AvatarGroup props
      </SectionSubtitle>
