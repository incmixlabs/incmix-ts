...
export default function IconDoc() {
  ...
  const contextualNavLinks: ContextualNavLink[] = [
    ...
    {
      href: "#using-third-party-icon-library",
      label: "Using a third-party icon library",
    },
    { href: "#creating-custom-icons", label: "Creating your custom icons" },
    {
      href: "#using-icon-component",
      label: "Using the `Icon` component",
      indent: true,
    },
    {
      href: "#using-create-icon-function",
      label: "Using the `createIcon` function",
      indent: true,
    },
    {
      href: "#tips",
      label: "Tips for generating your own icons",
      indent: true,
    },
  ...
  return (
    ...
    >
      ...
      <Text mb="$3">
        To use third-party icon libraries, here are the steps:
      </Text>
      <incmix.ul ps="$6" mb="$5">
        <incmix.li mb="$2">
          Import the <Code>Icon</Code> component from{" "}
          <Code>@incmix-ui/solid</Code>.
        </incmix.li>
        <incmix.li>
      ...
      <CodeSnippet
        snippet={snippets.usingThirdPartyIconLibrary}
        mb="$12"
      ></CodeSnippet>
      <SectionTitle id="creating-custom-icons">
        Creating your custom icons
      </SectionTitle>
      <Text mb="$3">
        Hope UI provides two methods for creating your custom icons:
      </Text>
      <incmix.ul ps="$6" mb="$5">
        <incmix.li mb="$2">
      ...
      <Text mb="$5">
        They can be imported from <Code>@incmix-ui/solid</Code>:
      </Text>
      ...
      <Text mb="$5">
        The <Code>createIcon</Code> function is a convenience wrapper around the
        process of generating icons with <Code>Icon</Code>, allowing you to
        achieve the same functionality with less effort.
      </Text>
      <CodeSnippet snippet={snippets.createIconExample} mb="$10" />
      <SectionSubtitle id="tips">
      ...
      <incmix.ul ps="$6" mb="$12">
        ...
        <incmix.li>
          To use the <Code>color</Code> style prop, set the <Code>fill</Code> or{" "}
          <Code>stroke</Code> prop of your svg <Code>path</Code> to{" "}
          <Code>currentColor</Code>.
        </incmix.li>
      </incmix.ul>
      <SectionTitle id="fallback-icon">Fallback icon</SectionTitle>
      <Text mb="$5">
        When <Code>children</Code> is not provided, the <Code>Icon</Code>{" "}
      ...
      <Text mb="$5">
        <Code>Icon</Code> render an <Code>svg</Code>, you can use any{" "}
        <Code>svg</Code> attributes.
      </Text>
