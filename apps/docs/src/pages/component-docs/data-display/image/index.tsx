import { HStack, Image, incmix, Text } from "@incmix/ui";
...
export default function ImageDoc() {
  ...
  const contextualNavLinks: ContextualNavLink[] = [
    ...
    {
      href: "#image-with-border-radius",
      label: "Image with border radius",
      indent: true,
    },
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        The size of the image can be adjusted using the <Code>boxSize</Code>{" "}
        prop.
      </Text>
      ...
      <SectionSubtitle id="image-with-border-radius">
        Image with border radius
      </SectionSubtitle>
      <Text mb="$5">
        The radius of the image can be adjusted using the{" "}
        <Code>borderRadius</Code> prop.
      </Text>
      ...
      <Text mb="$2">
        The <Code>Image</Code> component allows you provide a fallback
        placeholder. The placeholder is displayed when:
      </Text>
      <incmix.ul ps="$6" mb="$5">
        <incmix.li mb="$2">
          The <Code>fallback</Code> or <Code>fallbackSrc</Code> prop is
          provided.
        </incmix.li>
        <incmix.li mb="$2">
      ...
      <Text mb="$5">
        You can also opt out of this behavior by passing the{" "}
        <Code>ignoreFallback</Code> prop.
      </Text>
