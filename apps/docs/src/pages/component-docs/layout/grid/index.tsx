import { Anchor, Grid, GridItem, incmix, Text } from "@incmix/ui";
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        ...
        with <Code>display: grid</Code> and it comes with helpful style
        shorthand. It renders a <Code>div</Code> element.
      </Text>
      <SectionTitle id="import">Import</SectionTitle>
      <CodeSnippet snippet={snippets.importComponent} mb="$6" />
      <incmix.ul ps="$6" mb="$12">
        <incmix.li mb="$2">
          <strong>Grid:</strong> The main wrapper with{" "}
          <Code>display: grid</Code>.
        </incmix.li>
        <incmix.li>
          <strong>GridItem:</strong> Used as a child of <Code>Grid</Code> to
          control the span, and start positions within the grid.
        </incmix.li>
      </incmix.ul>
      <SectionTitle id="template-columns">Template columns</SectionTitle>
      <Text mb="$5">
        Here's an example of using grid template columns with the{" "}
        <Code>Grid</Code> component, and applying a <Code>gap</Code> (space)
      ...
      <Text mb="$5">
        In some layouts, you may need certain grid items to span specific amount
        of columns or rows instead of an even distribution.
      </Text>
      <Text mb="$5">
        To achieve this, you need to pass the <Code>colSpan</Code> prop to the{" "}
        <Code>GridItem</Code> component to span across columns and also pass the{" "}
        <Code>rowSpan</Code> component to span across rows. You also need to
        specify the <Code>templateColumns</Code> and
      ...
      <SectionTitle id="starting-and-ending-lines">
        Starting and ending lines
      </SectionTitle>
      <Text mb="$5">
        Pass the <Code>colStart</Code> and <Code>colEnd</Code> prop to{" "}
        <Code>GridItem</Code> component to make an element start or end at the{" "}
        <Code>nth</Code> grid position.
      </Text>
      ...
      <Text mb="$5">
        Grid composes <Code>Box</Code> so you can pass all the <Code>Box</Code>{" "}
        prop, css grid props, and these shorthand prop to save you some time:
      </Text>
