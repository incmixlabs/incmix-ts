import { Center, Divider, Text, VStack } from "@incmix/ui";
...
export default function DividerDoc() {
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        The <Code>Divider</Code> displays a thin horizontal or vertical line,
        and renders a <Code>div</Code> tag.
      </Text>
      ...
      <Text mb="$5">
        Pass the <Code>orientation</Code> prop and set it to either{" "}
      ...
      <Text mb="$5">
        If the vertical orientation is used, make sure that the parent element
        is assigned a height.
      </Text>
