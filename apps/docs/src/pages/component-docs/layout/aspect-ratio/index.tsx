import { Anchor, AspectRatio, Image, incmix, Text } from "@incmix/ui";
...
export default function AspectRatioDoc() {
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        To embed a video with a specific aspect ratio, use an iframe with{" "}
        <Code>src</Code> pointing to the link of the video.
      </Text>
      <Text mb="$5">
        Pass the <Code>maxWidth</Code> prop to <Code>AspectRatio</Code> to
      ...
      <Text mb="$5">
        Here's how to embed a responsive Google map using{" "}
        <Code>AspectRatio</Code>. To make the map take up the entire width, we
        can ignore the <Code>maxWidth</Code> prop.
      </Text>
