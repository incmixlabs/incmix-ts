import { Alert, AlertDescription, Box, Container, Text } from "@incmix/ui";
...
export default function ContainerDoc() {
  ...
  const contextualNavLinks: ContextualNavLink[] = [
    ...
    {
      href: "#centering-the-container",
      label: "Centering the container",
      indent: true,
    },
    {
      href: "#centering-the-children",
      label: "Centering the children",
      indent: true,
    },
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        By default, it sets the <Code>max-width</Code> of the content to match
        the <Code>min-width</Code> of the current breakpoint. This is useful if
        you’d prefer to design for a fixed set of screen sizes instead of trying
        to accommodate a fully fluid viewport.
      </Text>
      <Text mb="$5">
        You can customize this behavior by passing custom <Code>maxWidth</Code>{" "}
        values.
      </Text>
      ...
      <Text mb="$5">
        To contain any piece of content, wrap it in the <Code>Container</Code>{" "}
        component.
      </Text>
      ...
      <Alert status="info" mb="$12">
        <AlertDescription>
          The whole Hope UI docs is inside a <Code>Container</Code>, try resize
          your browser to see it in action.
        </AlertDescription>
      </Alert>
      <SectionSubtitle id="centering-the-container">
        Centering the container
      </SectionSubtitle>
      <Text mb="$5">
        By default the container is centered within its parent with a margin{" "}
        <Code>auto</Code> on left and right, you can disabled this behavior by
        setting the <Code>centered</Code> prop to <Code>false</Code>.
      </Text>
      ...
      <SectionSubtitle id="centering-the-children">
        Centering the children
      </SectionSubtitle>
      <Text mb="$5">
        In some cases, the width of the content can be smaller than the
        container's width, you can use the <Code>centerContent</Code> prop to
        center the content.
      </Text>
