  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        ...
        with <Code>display: flex</Code> and comes with helpful style shorthand.
        It renders a <Code>div</Code> element.
      </Text>
      <SectionTitle id="import">Import</SectionTitle>
      <CodeSnippet snippet={snippets.importComponent} mb="$6" />
      <incmix.ul ps="$6" mb="$12">
        <incmix.li mb="$2">
          <strong>Flex:</strong> A <Code>Box</Code> with{" "}
          <Code>display: flex</Code>.
        </incmix.li>
        <incmix.li>
          <strong>Spacer:</strong> Creates an adjustable, empty space that can
          be used to tune the spacing between child elements within{" "}
          <Code>Flex</Code>.
        </incmix.li>
      </incmix.ul>
      ...
      <Text mb="$5">
        While you can pass the verbose props, using the shorthand can save you
        some time.
      </Text>
      ...
      <Text mb="$5">
        As an alternative to <Code>Stack</Code>, you can combine{" "}
        <Code>Flex</Code> and <Code>Spacer</Code> to create stackable and
        responsive layouts.
      </Text>
      ...
      <Text mb="$4">
        The <Code>Flex</Code> and <Code>Spacer</Code> components,{" "}
        <Code>Grid</Code> and <Code>HStack</Code> treat children of different
        widths differently.
      </Text>
      <incmix.ul ps="$6" mb="$6">
        <incmix.li mb="$2">
          With <Code>Flex</Code> and <Code>Spacer</Code>, the children will span
          the entire width of the container and also have equal spacing between
          them.
        </incmix.li>
        <incmix.li mb="$2">
          In <Code>Grid</Code>, the starting points of the children will be
          equally spaced but the gaps between them will not be equal.
        </incmix.li>
        <incmix.li>
          In <Code>HStack</Code>, the children will have equal spacing between
          them but they won't span the entire width of the container.
        </incmix.li>
      </incmix.ul>
      ...
      <Text mb="$5">
        A good use case for <Code>Spacer</Code> is to create a navbar with a
