...
export default function AnchorDoc() {
  const previousLink: ContextualNavLink = {
    href: "/docs/data-display/tree-view",
    label: "TreeView",
  };
  ...
  const contextualNavLinks: ContextualNavLink[] = [
    ...
    {
      href: "#anchor-inline-with-text",
      label: "Anchor inline with text",
      indent: true,
    },
    {
      href: "#usage-with-routing-library",
      label: "Usage with routing library",
    },
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        Anchors are accessible elements used primarily for navigation. This
      ...
      <Preview snippet={snippets.externalLink} mb="$10">
        <Anchor href="https://incmix-ui.com" external>
          Hope UI <IconExternalLink ml="2px" verticalAlign="text-bottom" />
        </Anchor>
      </Preview>
      <SectionSubtitle id="anchor-inline-with-text">
        Anchor inline with text
      </SectionSubtitle>
      ...
      <SectionTitle id="usage-with-routing-library">
        Usage with routing library
      </SectionTitle>
      <Text mb="$5">
        To use the <Code>Anchor</Code> with a routing library like{" "}
        <Code>solid-app-router</Code>, all you need to do is pass the{" "}
        <Code>as</Code> prop. It'll replace the rendered <Code>a</Code> tag with
        the router's <Code>Link</Code>.
      </Text>
      <CodeSnippet snippet={snippets.usageWithRoutingLibrary} mb="$12" />
      <SectionTitle id="theming">Theming</SectionTitle>
      <Text mb="$5">
        <Code>Anchor</Code> base styles and default props can be overridden in
