...
export default function TabsDoc() {
  ...
  const handleSliderChange: JSX.EventHandlerUnion<HTMLInputElement, Event> = (
    event
  ) => {
  ...
  const contextualNavLinks: ContextualNavLink[] = [
    ...
    {
      href: "#initial-active-tab",
      label: "Make a tab initially active",
      indent: true,
    },
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        An accessible tabs component that provides keyboard interactions and
        ARIA attributes described in the{" "}
        <Anchor
      ...
      <UnorderedList spacing="$2" mb="$12">
        ...
        <ListItem>
          <strong>Tab:</strong> Element that serves as a label for one of the
          tab panels and can be activated to display that panel.
        </ListItem>
        <ListItem>
          <strong>TabPanel:</strong> Element that contains the content
      ...
      <Text mb="$5">
        Use the <Code>colorScheme</Code> prop to change the color of the Tabs.
        You can set the value to <Code>primary</Code>, <Code>accent</Code>,{" "}
        <Code>neutral</Code>, <Code>success</Code>, <Code>info</Code>,{" "}
      ...
      <Text mb="$5">
        Use the <Code>size</Code> prop to change the size of the Tabs. You can
        set the value to <Code>sm</Code>, <Code>md</Code> or <Code>lg</Code>.
      </Text>
      ...
      <Text mb="$5">
        ...
        Tabs. You can set the value to <Code>underline</Code>,{" "}
        <Code>outline</Code>, <Code>cards</Code> or <Code>pills</Code>.
      </Text>
      ...
      <Text mb="$5">
        Use the <Code>aligment</Code> prop to change the alignment of the{" "}
        <Code>TabList</Code>. You can set the value to <Code>start</Code>,{" "}
        <Code>center</Code>, <Code>apart</Code> or <Code>end</Code>.
      </Text>
      ...
      <Text mb="$5">
        ...
        Tabs. You can set the value to <Code>horizontal</Code> or{" "}
        <Code>vertical</Code>.
      </Text>
      ...
      <Text mb="$5">
        Use the <Code>fitted</Code> prop to stretch the tab list to fit the
        container.
      </Text>
      ...
      <Text mb="$5">
        Use the <Code>disabled</Code> prop to disabled a <Code>Tab</Code>. When
        a <Code>Tab</Code> is disabled, it is skipped during keyboard navigation
      ...
      <SectionSubtitle id="initial-active-tab">
        Make a tab initially active
      </SectionSubtitle>
      <Text mb="$5">
        Use the <Code>defaultIndex</Code> prop to set a <Code>Tab</Code>{" "}
        initially active. Indexes start at 0.
      </Text>
      ...
      <SectionSubtitle id="keep-alive">
        Keeping tab panels alive
      </SectionSubtitle>
      <Text mb="$5">
        By default, when you switch between tabs the state of the tab panels are
        lost, use the <Code>keepAlive</Code> prop to keep tab panels alive even
        when there's not visible.
      </Text>
      ...
      <Text mb="$5">
        ...
        the <Code>Tabs</Code> like form inputs.
      </Text>
      ...
      <UnorderedList spacing="$2" mb="$8">
        ...
        <ListItem>
          <Code>TabList</Code> as <Code>aria-orientation</Code> set to{" "}
          <Code>horizontal</Code> or <Code>vertical</Code> based on the value of
          the <Code>orientation</Code> prop.
        </ListItem>
        <ListItem>
          <Code>Tab</Code> as <Code>role</Code> set to <Code>tab</Code>.
        </ListItem>
        <ListItem>
          <Code>Tab</Code> as <Code>aria-selected</Code> set to{" "}
          <Code>true</Code> when its selected.
        </ListItem>
        <ListItem>
          <Code>Tab</Code> as <Code>aria-controls</Code> set to the{" "}
          <Code>id</Code> of its associated <Code>TabPanel</Code>.
        </ListItem>
        <ListItem>
          <Code>TabPanel</Code> as <Code>role</Code> set to{" "}
          <Code>tabpanel</Code>.
        </ListItem>
        <ListItem>
          <Code>TabPanel</Code> as <Code>aria-labelledby</Code> set to the{" "}
          <Code>id</Code> of the <Code>Tab</Code> that labels it.
        </ListItem>
      </UnorderedList>
      <SectionSubtitle>Keyboard support</SectionSubtitle>
      <UnorderedList spacing="$2" mb="$12">
        <ListItem>
          <Kbd>←</Kbd> moves focus to the previous tab (in horizontal
          orientation).
        </ListItem>
        <ListItem>
        ...
        <ListItem>
          <Kbd>↑</Kbd> moves focus to the previous tab (in vertical
          orientation).
        </ListItem>
        <ListItem>
        ...
        <ListItem>
          <Kbd>tab</Kbd> when focus moves into the tab list, places focus on the
          active tab element.
        </ListItem>
      </UnorderedList>
      <SectionTitle id="theming">Theming</SectionTitle>
      <Text mb="$5">
        <Code>Tabs</Code> base styles and default props can be overridden in the
      ...
      <Text>
        <Code>TabList</Code>, <Code>TabPanels</Code> and <Code>TabPanel</Code>{" "}
        composes{" "}
        <Anchor
          as={Link}
