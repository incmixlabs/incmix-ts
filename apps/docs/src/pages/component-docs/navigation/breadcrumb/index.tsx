...
export default function BreadcrumbDoc() {
  ...
  const contextualNavLinks: ContextualNavLink[] = [
    ...
    {
      href: "#breadcrumb-link-props",
      label: "BreadcrumbLink props",
      indent: true,
    },
    {
  ...
  return (
    ...
    >
      ...
      <UnorderedList spacing="$2" mb="$12">
        ...
        <ListItem>
          <strong>BreadcrumbItem:</strong> Individual breadcrumb element
          containing a link and separator.
        </ListItem>
        <ListItem>
          <strong>BreadcrumbLink:</strong> The breadcrumb link.
        </ListItem>
        <ListItem>
          <strong>BreadcrumbSeparator:</strong> The visual separator between
          each breadcrumb.
        </ListItem>
      </UnorderedList>
      <SectionTitle id="usage">Usage</SectionTitle>
      <Text mb="$5">
        Add the <Code>currentPage</Code> prop to the <Code>BreadcrumbLink</Code>{" "}
        that matches the current path. When this prop is present, the{" "}
        <Code>BreadcrumbLink</Code> renders a <Code>span</Code> with{" "}
        <Code>aria-current</Code> set to <Code>page</Code> instead of an anchor
        element.
      </Text>
      ...
      <Text mb="$5">
        Use the <Code>separator</Code> prop to change the separator used in the
        breadcrumb.
      </Text>
      ...
      <SectionSubtitle id="icon-as-separator">
        Using icon as separator
      </SectionSubtitle>
      <Text mb="$5">
        You can pass any <Code>JSX.Element</Code> to the <Code>separator</Code>{" "}
        prop.
      </Text>
      ...
      <SectionSubtitle id="with-end-separator">
        Using end separator
      </SectionSubtitle>
      <Text mb="$5">
      ...
      <Text mb="$5">
        Use the <Code>spacing</Code> prop to apply left and right margin to each
        separator.
      </Text>
      ...
      <Text mb="$5">
        ...
        so you can pass all <Code>Box</Code> props to change the style of the
        breadcrumbs.
      </Text>
      ...
      <SectionTitle id="with-routing-library">
        Usage with routing library
      </SectionTitle>
      <Text mb="$5">
        To use the Breadcrumb with a routing Library like{" "}
        <Code>solid-app-router</Code>, all you need to do is to pass the{" "}
        <Code>as</Code> prop to the <Code>BreadcrumbLink</Code> component.
      </Text>
      ...
      <UnorderedList spacing="$2" mb="$12">
        <ListItem>
          The Breadcrumbs are rendered in a <Code>nav</Code> to denote that it
          is a navigation landmark.
        </ListItem>
        <ListItem>
          The Breadcrumb <Code>nav</Code> has <Code>aria-label</Code> set to{" "}
        ...
        <ListItem>
          The separator has <Code>role</Code> set to <Code>presentation</Code>{" "}
          to denote that its for presentation purposes.
        </ListItem>
      </UnorderedList>
      <SectionTitle id="theming">Theming</SectionTitle>
      <Text mb="$5">
        <Code>Breadcrumb</Code> base styles and default props can be overridden
      ...
      <SectionSubtitle id="breadcrumb-link-props">
      ...
      <Text>
        <Code>BreadcrumbItem</Code> and <Code>BreadcrumbSeparator</Code>{" "}
        composes{" "}
        <Anchor
          as={Link}
          href="/docs/layout/box"
