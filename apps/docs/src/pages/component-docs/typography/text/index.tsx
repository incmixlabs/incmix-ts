import { Text, VStack } from "@incmix/ui";
...
export default function TextDoc() {
  ...
  const propItems: PropsTableItem[] = [
    {
      name: "size",
      description:
        "The size of the text. It apply a combination of `font-size` and `line-height`.",
  ...
  return (
    ...
    >
      ...
      <Text mb="$8">
        <Code>Text</Code> component is the used to render text and paragraphs
        within an interface. It renders a <Code>p</Code> tag by default.
      </Text>
      ...
      <SectionSubtitle id="override-element">
        Override the element
      </SectionSubtitle>
      <Text mb="$5">
        To override the element that gets rendered, pass the <Code>as</Code>{" "}
        prop. Use <strong>Inspect Element</strong> to see the element that gets
        rendered in html.
      </Text>
      ...
      <Text mb="$5">
        <Code>Text</Code> base styles and default props can be overridden in the
