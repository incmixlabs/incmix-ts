  ...
  const propItems: PropsTableItem[] = [
    {
      name: "level",
      description:
        "The level of the heading. For example, level 3 renders an `h3`.",
      type: "1 | 2 | 3 | 4 | 5 | 6",
    },
    {
      name: "size",
      description:
        "The size of the text. A combination of `font-size` and `line-height`.",
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        ...
        so you can use all the style props and add responsive styles as well. It
        renders a semibold <Code>h2</Code> tag by default.
      </Text>
      ...
      <Text mb="$5">
        To change the rendered <Code>h</Code> tag pass the <Code>level</Code>{" "}
        prop with a value from 1 to 6. For example, level 3 will render an{" "}
        <Code>h3</Code>. Use <strong>Inspect Element</strong> to see the element
        that gets rendered in html.
      </Text>
      ...
      <Alert status="warning" mb="$12">
        <AlertDescription>
          The <Code>level</Code> prop is primarily for semantic purpose as it
          does not alter the heading styles
        </AlertDescription>
      </Alert>
      <SectionSubtitle id="changing-font-size">
        Changing the font size
      </SectionSubtitle>
      <Text mb="$5">
        To increase the font size of the text, you can pass the{" "}
        <Code>size</Code> prop. It apply a combination of <Code>fontSize</Code>{" "}
        and <Code>lineHeight</Code> for an optimal reading experience.
      </Text>
      ...
      <Text mb="$5">
        If you'd like to truncate the text after a specific number of lines,
        pass the <Code>noOfLines</Code> prop and set it to the desired number of
        lines. It will render an ellipsis when the text exceeds the width of the
      ...
      <Text mb="$5">
        You can change the entire style of the text via props. For example, to
        change the font size, pass the <Code>fontSize</Code> prop.
      </Text>
      ...
      <Text mb="$5">
        <Code>Heading</Code> base styles and default props can be overridden in
