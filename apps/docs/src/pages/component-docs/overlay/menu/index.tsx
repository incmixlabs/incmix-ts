...
export default function MenuDoc() {
  ...
  const contextualNavLinks: ContextualNavLink[] = [
    ...
    { href: "#usage", label: "Usage" },
    {
      ...
      label: "Accessing the internal state",
      indent: true,
    },
    {
      href: "#custom-menu-trigger",
      label: "Custom menu trigger",
      indent: true,
    },
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        ...
        pattern. <Code>Menu</Code> implement the{" "}
        <Anchor
      ...
      <UnorderedList spacing="$2" mb="$12">
        <ListItem>
          <strong>Menu:</strong> The wrapper component that provides context for
          all its children.
        </ListItem>
        <ListItem>
        ...
        <ListItem>
          <strong>MenuContent:</strong> The component that pops out when the
          menu is open.
        </ListItem>
        <ListItem>
          <strong>MenuGroup:</strong> The component used to group multiple menu
          item.
        </ListItem>
        <ListItem>
          <strong>MenuLabel:</strong> The component used to render the label of
          a group.
        </ListItem>
        <ListItem>
      ...
      <Text mb="$5">
        To access the internal state of the <Code>Menu</Code>, use a function as
        children (commonly known as a render prop). You'll get access to the
        internal <Code>opened</Code> state.
      </Text>
      ...
      <SectionSubtitle id="custom-menu-trigger">
        Custom menu trigger
      </SectionSubtitle>
      <Text mb="$3">
        The default <Code>MenuTrigger</Code> can be styled using the usual
        styled-system props, but it starts off plainly styled.
      </Text>
      <Text mb="$12">
        You can use the <Code>as</Code> prop to render a custom component
        instead of the default <Code>MenuTrigger</Code>. For instance, you can
        use Hope UI's <Code>Button</Code> component, or your own custom
        component.
      </Text>
      <SectionSubtitle id="icons-and-commands">
        Icons and commands
      </SectionSubtitle>
      <Text mb="$5">
        You can add icon to each <Code>MenuItem</Code> by passing the{" "}
        <Code>icon</Code> prop. To add a commands (or hotkeys) to menu items,
        you can use the <Code>command</Code> prop.
      </Text>
      ...
      <SectionSubtitle id="typeahead-behavior">
        Typeahead behavior
      </SectionSubtitle>
      <Text mb="$5">
        When focus is on the <Code>MenuTrigger</Code> or within the{" "}
        <Code>MenuContent</Code> and you type a letter key, a search begins.
        Focus will move to the first <Code>MenuItem</Code> that starts with the
        letter you typed.
      </Text>
      ...
      <Alert status="warning" mb="$10">
        <AlertDescription>
          If the content of <Code>MenuItem</Code> is too complex or non-textual
          you can pass the <Code>textValue</Code> prop to <Code>MenuItem</Code>{" "}
          to indicate the text that will be used for typeahead purposes.
        </AlertDescription>
      </Alert>
      <SectionSubtitle id="menu-item-colors">MenuItem colors</SectionSubtitle>
      <Text mb="$5">
        Use the <Code>colorScheme</Code> prop to change the color of the{" "}
        <Code>MenuItem</Code>. You can set the value to <Code>primary</Code>,{" "}
        <Code>accent</Code>, <Code>neutral</Code>, <Code>success</Code>,{" "}
      ...
      <SectionSubtitle id="disabled-menu-item">
        Disabled MenuItem
      </SectionSubtitle>
      <Text mb="$5">
      ...
      <Text mb="$5">
        Pass a callback to the <Code>onSelect</Code> prop to trigger an action
        when the <Code>MenuItem</Code> is selected.
      </Text>
      <Preview snippet={snippets.triggerAction} mb="$10">
        <Menu>
          ...
          <MenuContent>
            <MenuItem onSelect={() => alert("Downloading...")}>
              Download
            </MenuItem>
            <MenuItem onSelect={() => alert("Copying...")}>
              Create a Copy
            </MenuItem>
          </MenuContent>
        </Menu>
      ...
      <Text mb="$5">
        Use the <Code>MenuGroup</Code> and <Code>MenuLabel</Code> components to
      ...
      <UnorderedList spacing="$2" mb="$8">
        <ListItem>
          <Code>MenuTrigger</Code> as <Code>role</Code> set to{" "}
          <Code>button</Code>.
        </ListItem>
        <ListItem>
          <Code>MenuTrigger</Code> as <Code>aria-haspopup</Code> set to{" "}
          <Code>menu</Code>.
        </ListItem>
        <ListItem>
          <Code>MenuTrigger</Code> as <Code>aria-expanded</Code> set to{" "}
          <Code>true</Code> when the menu is displayed.
        </ListItem>
        <ListItem>
          <Code>MenuTrigger</Code> as <Code>aria-controls</Code> set to the id
          of <Code>MenuContent</Code>.
        </ListItem>
        <ListItem>
        ...
        <ListItem>
          <Code>MenuContent</Code> as <Code>aria-orientation</Code> set to{" "}
          <Code>vertical</Code>.
        </ListItem>
        <ListItem>
          <Code>MenuItem</Code> as <Code>role</Code> set to{" "}
          <Code>menuitem</Code>.
        </ListItem>
      </UnorderedList>
      ...
      <UnorderedList spacing="$2" mb="$8">
        <ListItem>
          <Kbd>enter</Kbd>, <Kbd>space</Kbd> or <Kbd>↓</Kbd> opens the menu and
          moves focus on the first menu item.
        </ListItem>
        <ListItem>
      ...
      <UnorderedList spacing="$2" mb="$8">
        <ListItem>
          <Kbd>enter</Kbd> or <Kbd>space</Kbd> activates the menu item, close
          the menu and sets focus to the menu trigger.
        </ListItem>
        <ListItem>
          <Kbd>esc</Kbd> close the menu and sets focus to the menu trigger.
        </ListItem>
        <ListItem>
          <Kbd>↑</Kbd> moves focus to the previous menu item. If focus is on the
          first menu item, moves focus to the last menu item.
        </ListItem>
        <ListItem>
          <Kbd>↓</Kbd> moves focus to the next menu item. If focus is on the
          last menu item, moves focus to the first menu item.
        </ListItem>
        <ListItem>
      ...
      <UnorderedList spacing="$2" mb="$12">
        <ListItem>
          Any printable characters move visual focus to the first menu item that
          matches the typed character.
        </ListItem>
        <ListItem>
          If multiple keys are typed in quick succession, visual focus moves to
          the first menu item that matches the full string.
        </ListItem>
        <ListItem>
          If the same character is typed in succession, visual focus cycles
          among the menu items starting with that character.
        </ListItem>
      </UnorderedList>
      <SectionTitle id="theming">Theming</SectionTitle>
      <Text mb="$5">
        <Code>Menu</Code> base styles and default props can be overridden in the
        Hope UI theme configuration like below:
      </Text>
      ...
      <Text>
        <Code>MenuTrigger</Code>, <Code>MenuContent</Code>,{" "}
        <Code>MenuGroup</Code> and <Code>MenuLabel</Code> composes{" "}
        <Anchor
          as={Link}
