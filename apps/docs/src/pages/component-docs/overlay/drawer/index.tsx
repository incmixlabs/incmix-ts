...
export default function DrawerDoc() {
  ...
  const contextualNavLinks: ContextualNavLink[] = [
    ...
    {
      href: "#using-form-in-drawer",
      label: "Using a form in a Drawer",
      indent: true,
    },
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        The <Code>Drawer</Code> component is a panel that slides out from the
        edge of the screen. It can be useful when you need users to complete a
      ...
      <UnorderedList spacing="$2" mb="$12">
        <ListItem>
          <strong>Drawer:</strong> The wrapper that provides context for its
          children.
        </ListItem>
        <ListItem>
          <strong>DrawerOverlay:</strong> The dimmed overlay behind the drawer
          content.
        </ListItem>
        <ListItem>
          <strong>DrawerContent:</strong> The container for the drawer's
          content.
        </ListItem>
        <ListItem>
        ...
        <ListItem>
          <strong>DrawerBody:</strong> The wrapper that houses the drawer's main
          content.
        </ListItem>
        <ListItem>
          <strong>DrawerFooter:</strong> The footer that houses the drawer
          actions.
        </ListItem>
        <ListItem>
          ...
          <DrawerContent>
            ...
            <DrawerFooter>
              <Button
                variant="outline"
                mr="$3"
                onClick={basicUsageDisclosure.onClose}
              >
                Cancel
              </Button>
              <Button>Save</Button>
      ...
      <Text mb="$5">
        ...
        <Code>placement</Code> prop and set it to <Code>top</Code>,{" "}
      ...
      <Text mb="$5">
        ...
        drawer. However, there might be scenarios where you need to manually
          ...
          <DrawerContent>
            ...
            <DrawerFooter>
              <Button
                variant="outline"
                mr="$3"
                onClick={initialFocusDisclosure.onClose}
              >
                Cancel
              </Button>
              <Button>Save</Button>
      ...
      <Alert status="warning" mb="$10">
        <AlertDescription>
          Without the <Code>initialFocus</Code> prop, the drawer will set focus
          on the <strong>first focusable element</strong> when it opens.
        </AlertDescription>
      </Alert>
      ...
      <Text mb="$5">
        ...
        drawer. Values can be <Code>xs</Code>, <Code>sm</Code>, <Code>md</Code>,{" "}
        <Code>lg</Code>, <Code>xl</Code>, or <Code>full</Code>.
      </Text>
      ...
      <SectionSubtitle id="using-form-in-drawer">
        Using a form in a Drawer
      </SectionSubtitle>
      <Text mb="$5">
        If you need to but a form within the Drawer and place the sumit button
        in the drawer's footer, here's the recommended way to do it:
      </Text>
      <CodeSnippet snippet={snippets.usingForm} mb="$6" />
      <Alert status="warning" mb="$12">
        <AlertDescription>
          Because the button is located outside the form, you have to leverage
          its native HTML <Code>form</Code> attribute and refer to the{" "}
          <Code>id</Code> of the <Code>form</Code>.
        </AlertDescription>
      </Alert>
      ...
      <UnorderedList spacing="$2" mb="$12">
        ...
        <ListItem>
          By default, the drawer sets focus on the first focusable element. If
          the <Code>initialFocus</Code> prop is passed, the drawer sets focus on
          the element that matches the CSS query selector.
        </ListItem>
        <ListItem>
          After the drawer closes, it'll return focus to the element that
          triggered it.
        </ListItem>
      </UnorderedList>
      <SectionTitle id="theming">Theming</SectionTitle>
      <Text mb="$5">
        <Code>Drawer</Code> base styles and default props can be overridden in
      ...
      <UnorderedList spacing="$2">
        <ListItem>
          <Code>DrawerOverlay</Code>, <Code>DrawerContent</Code>,{" "}
          <Code>DrawerHeader</Code>, <Code>DrawerBody</Code> and{" "}
