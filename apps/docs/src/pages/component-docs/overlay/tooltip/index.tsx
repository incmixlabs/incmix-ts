...
export default function TooltipDoc() {
  ...
  const contextualNavLinks: ContextualNavLink[] = [
    ...
    {
      href: "#with-focusable-content",
      label: "Tooltip with focusable content",
      indent: true,
    },
  ...
  const propItems: PropsTableItem[] = [
    ...
    },
    {
      name: "offset",
      description:
        "The offset between the tooltip and the reference (trigger) element.",
      type: "number",
      defaultValue: "8",
    },
    {
  ...
  return (
    ...
    >
      ...
      <SectionSubtitle id="with-focusable-content">
        Tooltip with focusable content
      </SectionSubtitle>
      <Text mb="$5">
        If the children of the tooltip is a focusable element, the tooltip will
        show when you focus or hover on the element, and will hide when you blur
        or move cursor out of the element.
      </Text>
      ...
      <Text mb="$5">
        Use the <Code>disabled</Code> prop to prevent the tooltip from showing
        up.
      </Text>
      ...
      <Text mb="$5">
        Using the <Code>placement</Code> prop you can adjust where your tooltip
        will be displayed.
      </Text>
      ...
      <Text mb="$5">
        <Code>Tooltip</Code> base styles and default props can be overridden in
