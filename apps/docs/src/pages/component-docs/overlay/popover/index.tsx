...
export default function PopoverDoc() {
  ...
  const contextualNavLinks: ContextualNavLink[] = [
    ...
    {
      href: "#accessing-internal-state",
      label: "Accessing internal state",
      indent: true,
    },
  ...
  const propItems: PropsTableItem[] = [
    ...
    },
    {
      name: "defaultOpened",
      description:
        "If `true`, the popover will be initially shown (in uncontrolled mode).",
      type: "boolean",
    },
    {
      name: "triggerMode",
  ...
  return (
    ...
    >
      ...
      <UnorderedList spacing="$2" mb="$12">
        <ListItem>
          <strong>Popover:</strong> The wrapper that provides props, state, and
          context to its children.
        </ListItem>
        <ListItem>
          <strong>PopoverTrigger:</strong> The component that opens/closes the
          popover.
        </ListItem>
        <ListItem>
          <strong>PopoverAnchor:</strong> The component to use as positioning
          reference instead of the trigger.
        </ListItem>
        <ListItem>
          <strong>PopoverContent:</strong> The popover itself.
        </ListItem>
        <ListItem>
          <strong>PopoverArrow:</strong> A visual arrow that points to the
          reference (trigger or anchor) element.
        </ListItem>
        <ListItem>
      ...
      <Text mb="$5">
        <Code>PopoverTrigger</Code> renders an unstyled <Code>button</Code> by
        default. For accessiblity reason, when using the <Code>as</Code> prop
        ensure the element passed in is focusable.
      </Text>
      ...
      <Text mb="$5">
        Use the <Code>triggerMode</Code> prop to change the way of opening the
        popover. You can set the value to <Code>hover</Code> or{" "}
        <Code>click</Code>.
      </Text>
      ...
      <Text mb="$5">
        By default, focus is sent to <Code>PopoverContent</Code> when it opens.
        Use the <Code>initialFocus</Code> prop to send focus to a specific
        element instead.
      </Text>
      ...
      <SectionSubtitle id="focus-trap">
        Trapping focus within popover
      </SectionSubtitle>
      <Text mb="$5">
        Use the <Code>trapFocus</Code> prop to lock focus inside the{" "}
      ...
      <SectionSubtitle id="popover-placement">
        Popover placement
      </SectionSubtitle>
      <Text mb="$5">
        Use the <Code>placement</Code> prop to set the preferred popover
        placement. You can set the value to <Code>top</Code>, <Code>right</Code>
        , <Code>left</Code>, <Code>bottom</Code> and their <Code>-start</Code>{" "}
        or <Code>-end</Code> variants.
      </Text>
      ...
      <Text mb="$3">
        Use the <Code>PopoverAnchor</Code> component if you want to use a
        different element for the popover positioning reference.
      </Text>
      <Text mb="$5">
        In the example below, the <Code>Button</Code> is the trigger that
        opens/closes the popover and the <Code>Input</Code> is the reference
        element that the popover will position relative to.
      </Text>
      ...
      <SectionSubtitle id="accessing-internal-state">
        Accessing internal state
      </SectionSubtitle>
      <Text mb="$5">
        Popover provides access to its internal state <Code>opened</Code> state
        and an <Code>onClose</Code> method that you can access via a render
        prop.
      </Text>
      ...
      <SectionSubtitle id="controlled-popover">
        Controlled popover
      </SectionSubtitle>
      <Text mb="$5">
        Use the <Code>opened</Code> and <Code>onClose</Code> props to control
        the opening and closing of the popover.
      </Text>
      ...
      <Text mb="$5">
        <Code>Popover</Code> is made up of several components that you can
      ...
      <UnorderedList spacing="$2" mb="$8">
        <ListItem>
          <Code>PopoverTrigger</Code> has <Code>aria-haspopup</Code> set to{" "}
          <Code>dialog</Code> to denote that it triggers a popover.
        </ListItem>
        <ListItem>
          <Code>PopoverTrigger</Code> has <Code>aria-controls</Code> set to the{" "}
          <Code>id</Code> of the <Code>PopoverContent</Code>.
        </ListItem>
        <ListItem>
          <Code>PopoverTrigger</Code> has <Code>aria-expanded</Code> set to{" "}
          <Code>true</Code> or <Code>false</Code> depending on the open/closed
          state of the popover.
        </ListItem>
        <ListItem>
          <Code>PopoverContent</Code> has <Code>aria-labelledby</Code> set to
          the <Code>id</Code> of the <Code>PopoverHeader</Code>.
        </ListItem>
        <ListItem>
          <Code>PopoverContent</Code> has <Code>aria-describedby</Code> set to
          the <Code>id</Code> of the <Code>PopoverBody</Code>.
        </ListItem>
        <ListItem>
          When the <Code>triggerMode</Code> is set to <Code>hover</Code>,{" "}
          <Code>PopoverContent</Code> has <Code>role</Code> set to{" "}
          <Code>tooltip</Code>, otherwise <Code>role</Code> is set to{" "}
          <Code>dialog</Code>.
        </ListItem>
      </UnorderedList>
      ...
      <UnorderedList spacing="$2" mb="$8">
        <ListItem>
          When the <Code>triggerMode</Code> prop is set to <Code>click</Code>,
          clicking the <Code>PopoverTrigger</Code> or pressing <Kbd>space</Kbd>{" "}
          or <Kbd>enter</Kbd> when focus is on the trigger will open the
          popover.
        </ListItem>
        <ListItem>
          When the <Code>triggerMode</Code> prop is set to <Code>hover</Code>,
          focusing on or mousing over the <Code>PopoverTrigger</Code> will open
          the popover.
        </ListItem>
      </UnorderedList>
      ...
      <UnorderedList spacing="$2" mb="$12">
        <ListItem>
          When the <Code>initialFocus</Code> prop is set, focus is moved to the
          matching element, otherwise focus moves to the{" "}
          <Code>PopoverContent</Code>.
        </ListItem>
        <ListItem>
          When the <Code>triggerMode</Code> prop is set to <Code>click</Code>,
          clicking the <Code>PopoverTrigger</Code> closes the popover.
        </ListItem>
        <ListItem>
          When the <Code>triggerMode</Code> prop is set to <Code>hover</Code>,
          blurring or mousing out of the <Code>PopoverTrigger</Code> will close
          the popover. If you move your mouse into the{" "}
          <Code>PopoverContent</Code>, it'll remain visible.
        </ListItem>
        <ListItem>
          When focus is within the <Code>PopoverContent</Code> and{" "}
          <Code>closeOnEsc</Code> prop is set to <Code>true</Code>, pressing{" "}
          <Kbd>esc</Kbd> closes the popover.
        </ListItem>
        <ListItem>
          When <Code>closeOnBur</Code> prop is set to <Code>true</Code>,
          clicking outside or blurring out of the <Code>PopoverContent</Code>{" "}
          closes the popover.
        </ListItem>
      </UnorderedList>
      <SectionTitle id="theming">Theming</SectionTitle>
      <Text mb="$5">
        <Code>Popover</Code> base styles and default props can be overridden in
      ...
      <UnorderedList spacing="$2">
        <ListItem>
          <Code>PopoverContent</Code>, <Code>PopoverArrow</Code>,{" "}
          <Code>PopoverHeader</Code>, <Code>PopoverBody</Code> and{" "}
          <Code>PopoverFooter</Code> composes{" "}
          <Anchor
            as={Link}
