...
export default function SelectDoc() {
  ...
  const [controlledMultiValue, setControlledMultiValue] = createSignal<
    string[]
  >([]);
  ...
  const contextualNavLinks: ContextualNavLink[] = [
    ...
    { href: "#default-value", label: "Default value", indent: true },
    {
      ...
      label: "Make an option disabled",
      indent: true,
    },
    { href: "#option-group", label: "Option group", indent: true },
    {
      href: "#typeahead-complex-option",
      label: "Typeahead with complex option",
      indent: true,
    },
  ...
  const selectPropItems: PropsTableItem[] = [
    ...
    },
    {
      name: "defaultValue",
      description:
        "The value of the select when initially rendered (in uncontrolled mode).",
      type: "string | number | (string | number)[]",
    },
    {
      name: "required",
    ...
    },
    {
      name: "invalid",
      description:
        "If `true`, the select trigger will have `aria-invalid` set to `true`.",
      type: "boolean",
    },
    {
      name: "readOnly",
    ...
    },
    {
      name: "onChange",
      description:
        "Callback invoked when the selected value changes (in controlled mode).",
  ...
  const selectIconPropItems: PropsTableItem[] = [
    {
      name: "rotateOnOpen",
      description:
        "If `true`, the icon will perform a 180deg rotation when the select is open",
      type: "boolean",
      defaultValue: "false",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        <Code>Select</Code> component is a component that allows users pick a
        value from predefined options. Ideally, it should be used when there are
        more than 5 options, otherwise you might consider using a radio group
        instead.
      </Text>
      ...
      <UnorderedList spacing="$2" mb="$12">
        <ListItem>
          <strong>Select:</strong> The wrapper component that provides context
        ...
        <ListItem>
          <strong>SelectPlaceholder:</strong> The component used to display a
          placeholder when no option is selected.
        </ListItem>
        <ListItem>
          <strong>SelectValue:</strong> The part that reflects the selected
          value in the trigger.
        </ListItem>
        <ListItem>
          <strong>SelectTag:</strong> The component used to display a selected
          value in a multi-select.
        </ListItem>
        <ListItem>
          <strong>SelectTagCloseButton:</strong> The button used to remove a
          selected option in a multi-select.
        </ListItem>
        <ListItem>
          <strong>SelectIcon:</strong> The container for the select dropdown
          icon.
        </ListItem>
        <ListItem>
          <strong>SelectContent:</strong> The component that pops out when the
          select is open.
        </ListItem>
        <ListItem>
          <strong>SelectListbox:</strong> The scrolling viewport that contains
          all of the options.
        </ListItem>
        <ListItem>
          <strong>SelectOptGroup:</strong> The component used to group multiple
          options.
        </ListItem>
        <ListItem>
        ...
        <ListItem>
          <strong>SelectOption:</strong> The component that contains a
          selectable option.
        </ListItem>
        <ListItem>
        ...
        <ListItem>
          <strong>SelectOptionIndicator:</strong> A visual indicator rendered
      ...
      <Text mb="$5">
        Use the <Code>size</Code> prop to change the size of the{" "}
        <Code>SelectTrigger</Code>. You can set the value to <Code>xs</Code>,{" "}
      ...
      <Text mb="$5">
        ...
        <Code>SelectTrigger</Code>. You can set the value to{" "}
      ...
      <Text mb="$5">
        Use the <Code>defaultValue</Code> prop to make an option selected by
        default.
      </Text>
      ...
      <SectionSubtitle id="disabled-option">
        Make an option disabled
      </SectionSubtitle>
      <Text mb="$5">
        Use the <Code>disabled</Code> prop on <Code>SelectOption</Code> to make
        an option disabled.
      </Text>
      ...
      <Text mb="$5">
        Use the <Code>SelectOptGroup</Code> and <Code>SelectLabel</Code> to
        visualy group options.
      </Text>
      ...
      <SectionSubtitle id="typeahead-complex-option">
        Typeahead with complex option
      </SectionSubtitle>
      <Text mb="$3">
        By default the typeahead behavior will use the <Code>.textContent</Code>{" "}
        of the <Code>SelectOption</Code>.
      </Text>
      <Text mb="$5">
        However, when the content is more complex than just a text, Use the{" "}
        <Code>textValue</Code> prop on <Code>SelectOption</Code> to define which
        text should be used for typeahead purposes.
      </Text>
      ...
      <Text mb="$5">
        Use the <Code>value</Code> and <Code>onChange</Code> props to control
        the select.
      </Text>
      ...
      <Text mb="$5">
        In a multi-select pass an array to the <Code>defaultValue</Code> prop to
        make some options selected by default.
      </Text>
      ...
      <SectionSubtitle id="multi-controlled">
        Controlled multi-select
      </SectionSubtitle>
      <Text mb="$5">
        In a multi-select <Code>value</Code> and <Code>onChange</Code> props
        uses arrays.
      </Text>
      <Preview snippet={snippets.multiSelectControlled} mb="$12">
        ...
        <Select
          multiple
          value={controlledMultiValue()}
          onChange={setControlledMultiValue}
        >
          <SelectTrigger>
            <SelectPlaceholder>Choose some frameworks</SelectPlaceholder>
            <SelectValue />
      ...
      <Text mb="$5">
        <Code>Select</Code> is made up of several components that you can
        customize to achieve your desired design.
      </Text>
      <Preview snippet={snippets.composition} mb="$6">
        <Select multiple offset={-1}>
          <SelectTrigger
            rounded="$none"
            _focus={{ shadow: "$none", borderColor: "$warning7" }}
          >
      ...
      <Text mb="$5">
        If you don't need to customize every parts of <Code>Select</Code> and
        want a simpler API, Hope UI exposes the <Code>SimpleSelect</Code> and{" "}
        <Code>SimpleOption</Code> components. Those are just abstraction over
        the base <Code>Select</Code> component.
      </Text>
      ...
      <Alert status="warning" mb="$12">
        <AlertDescription>
          ...
          <Anchor
            href="https://github.com/incmixlabs/incmix/tree/pnpm/packages/ui/src/components/simple-select"
            external
            color="$primary11"
            fontWeight="$semibold"
          >
      ...
      <UnorderedList spacing="$2" mb="$8">
        <ListItem>
          <Code>SelectTrigger</Code> has <Code>role</Code> of{" "}
          <Code>combobox</Code>.
        </ListItem>
        <ListItem>
          <Code>SelectTrigger</Code> has <Code>aria-haspopup</Code> set to{" "}
          <Code>listbox</Code>.
        </ListItem>
        <ListItem>
          <Code>SelectTrigger</Code> has <Code>aria-controls</Code> set to the{" "}
          <Code>id</Code> of <Code>SelectListbox</Code>.
        </ListItem>
        <ListItem>
          <Code>SelectTrigger</Code> has <Code>aria-expanded</Code> set to{" "}
          <Code>true</Code> when the listbox is displayed and <Code>false</Code>{" "}
          otherwise.
        </ListItem>
        <ListItem>
          When the select is open, <Code>SelectTrigger</Code> has{" "}
          <Code>aria-activedescendant</Code> set to the <Code>id</Code> of the
          active <Code>SelectOption</Code>.
        </ListItem>
        <ListItem>
          <Code>SelectListbox</Code> has <Code>role</Code> of{" "}
          <Code>listbox</Code>.
        </ListItem>
        <ListItem>
        ...
        <ListItem>
          The selected <Code>SelectOption</Code> has <Code>aria-selected</Code>{" "}
      ...
      <UnorderedList spacing="$2" mb="$8">
        <ListItem>
          <Kbd>enter</Kbd>, <Kbd>space</Kbd> , <Kbd>↓</Kbd> and <Kbd>↑</Kbd>{" "}
          opens the select and move visual focus to the first option or the
          selected one.
        </ListItem>
        <ListItem>
          <Kbd>home</Kbd> open the select and move visual focus to the first
          option.
        </ListItem>
        <ListItem>
          <Kbd>end</Kbd> open the select and move visual focus to the last
          option.
        </ListItem>
        <ListItem>
      ...
      <UnorderedList spacing="$2" mb="$8">
        <ListItem>
          <Kbd>enter</Kbd>, <Kbd>space</Kbd> or <Kbd>alt</Kbd> + <Kbd>↑</Kbd>{" "}
          select the option and close the select.
        </ListItem>
        <ListItem>
        ...
        <ListItem>
          <Kbd>home</Kbd> and <Kbd>pageup</Kbd> move visual focus to the first
          option.
        </ListItem>
        <ListItem>
          <Kbd>end</Kbd> and <Kbd>pagedown</Kbd> move visual focus to the last
          option.
        </ListItem>
        <ListItem>
          <Kbd>tab</Kbd> closes the select and moves focus to the next focusable
          element.
        </ListItem>
        <ListItem>
      ...
      <UnorderedList spacing="$2" mb="$12">
        <ListItem>
          Any printable characters move visual focus to the first option that
          matches the typed character.
        </ListItem>
        <ListItem>
          If multiple keys are typed in quick succession, visual focus moves to
          the first option that matches the full string.
        </ListItem>
        <ListItem>
          If the same character is typed in succession, visual focus cycles
          among the options starting with that character.
        </ListItem>
      </UnorderedList>
      <SectionTitle id="theming">Theming</SectionTitle>
      <Text mb="$5">
        <Code>Select</Code> base styles and default props can be overridden in
      ...
      <SectionSubtitle id="select-option-props">
        SelectOption props
      </SectionSubtitle>
      <PropsTable items={selectOptionPropItems} mb="$10" />
      <SectionSubtitle id="select-value-props">
        SelectValue props
      </SectionSubtitle>
