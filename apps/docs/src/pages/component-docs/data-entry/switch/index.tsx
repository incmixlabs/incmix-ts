...
export default function SwitchDoc() {
  ...
  const contextualNavLinks: ContextualNavLink[] = [
    ...
    {
      href: "#switch-primitive-props",
      label: "SwitchPrimitive props",
      indent: true,
    },
  ...
  const switchPrimitivePropItems: PropsTableItem[] = [
    ...
    },
    {
      name: "invalid",
      description:
        "If `true`, the switch will have `aria-invalid` set to `true`.",
      type: "boolean",
    },
    {
      name: "readOnly",
  ...
  return (
    ...
    >
      ...
      <UnorderedList spacing="$2" mb="$12">
        <ListItem>
          <strong>SwitchPrimitive:</strong> Unstyled component containing all
          the parts of a switch. It renders a <Code>label</Code> and a visualy
          hidden <Code>input</Code> with type set to <Code>checkbox</Code> and
          role set to <Code>switch</Code>.
        </ListItem>
        <ListItem>
          <strong>SwitchPrimitiveThumb:</strong> The thumb that is used to
          visually indicate whether the switch is on or off.
        </ListItem>
        <ListItem>
      ...
      <Text mb="$5">
        Use the <Code>colorScheme</Code> prop to change the color of the Switch.
      ...
      <Text mb="$5">
        Use the <Code>size</Code> prop to change the size of the Switch. You can
      ...
      <Text mb="$5">
        ...
        Switch. You can set the value to <Code>outline</Code> or{" "}
        <Code>filled</Code>.
      </Text>
      ...
      <Text mb="$5">
        Use the unstyled <Code>SwitchPrimitive</Code> component to achieve your
        desired design. You can pair it with your styling solution of choice.
        The below example uses style props and the <Code>css</Code> function.
      </Text>
      ...
      <Text mb="$5">
        <Code>Switch</Code> base styles and default props can be overridden in
        the Hope UI theme configuration like below:
      </Text>
      <CodeSnippet lang="js" snippet={snippets.theming} mb="$12" />
      <SectionTitle id="props">Props</SectionTitle>
      <SectionSubtitle id="switch-primitive-props">
      ...
      <Text mb="$5">
        <Code>Switch</Code> composes the <Code>SwitchPrimitive</Code> component,
        so you can pass all its props. These are props specific to the{" "}
