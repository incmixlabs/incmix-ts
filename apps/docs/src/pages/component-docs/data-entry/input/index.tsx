...
export default function InputDoc() {
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        The <Code>Input</Code> component is a component that is used to get user
      ...
      <Text mb="$5">
        Use the <Code>size</Code> prop to change the size of the Input. You can
      ...
      <Text mb="$5">
        If you want to use the native DOM <Code>size</Code> attribute you can
        use the <Code>htmlSize</Code> prop. For it to work as expected you will
        also need to provide the <Code>width</Code> prop set to{" "}
        <Code>auto</Code>.
      </Text>
      ...
      <Text mb="$5">
        ...
        Input. You can set the value to <Code>outline</Code>,{" "}
      ...
      <Text mb="$5">
        You can add addons to the left and right of the <Code>Input</Code>{" "}
        component. Hope UI exports <Code>InputGroup</Code>,{" "}
        <Code>InputLeftAddon</Code> and <Code>InputRightAddon</Code> to help
        with this use case.
      </Text>
      ...
      <Text mb="$5">
        ...
        input component. Hope UI exports <Code>InputLeftElement</Code> and{" "}
        <Code>InputRightElement</Code> to help with this use case.
      </Text>
      <Text mb="$5">
        If the left or right is an icon or text, you can pass{" "}
        <Code>pointerEvents="none"</Code> to <Code>InputLeftElement</Code> or{" "}
        <Code>InputRightElement</Code> to ensure that clicking on them focused
        the input.
      </Text>
      ...
      <Text mb="$5">
        <Code>Input</Code> base styles and default props can be overridden in
