...
export default function FormControlDoc() {
  ...
  const handleInvalidInput: JSX.EventHandlerUnion<
    HTMLInputElement,
    InputEvent
  > = (event) => {
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        FormControl provides context such as <Code>required</Code>,{" "}
        <Code>disabled</Code> and <Code>invalid</Code> to form elements. It
        follows the{" "}
        <Anchor
      ...
      <UnorderedList spacing="$2" mb="$12">
        <ListItem>
          <strong>FormControl:</strong> The wrapper that provides context and
          functionality for all children.
        </ListItem>
        <ListItem>
          <strong>FormLabel:</strong> The label of a form section. The usage is
          similar to html label.
        </ListItem>
        <ListItem>
          <strong>FormHelperText:</strong> The message that tells users more
          details about the form section.
        </ListItem>
        <ListItem>
          <strong>FormErrorMessage:</strong> The message that shows up when an
          error occurs.
        </ListItem>
      </UnorderedList>
      ...
      <Text mb="$5">
        Use the <Code>required</Code> prop to make the form control required.
        The Input field will have <Code>aria-required</Code> set to{" "}
        <Code>true</Code>, and the <Code>FormLabel</Code> will show a red
        asterisk.
      </Text>
      ...
      <Text mb="$5">
        ...
        <Code>FormErrorMessage</Code> will only show up when the{" "}
        <Code>invalid</Code> prop is true.
      </Text>
      ...
      <SectionSubtitle id="usage-with-select">
        Usage with select
      </SectionSubtitle>
      ...
      <Alert status="warning" mb="$12">
        <AlertDescription>
          You can also use the more composable <Code>Select</Code> component
          instead of <Code>SimpleSelect</Code>.
        </AlertDescription>
      </Alert>
      <SectionTitle id="usage-with-form-libraries">
        Usage with form libraries
      </SectionTitle>
      <Text mb="$5">
        The below example demonstrate the use of <Code>FormControl</Code> and
        others Hope UI form related components with the{" "}
        <Anchor
      ...
      <UnorderedList spacing="$2" mb="$8">
        <ListItem>
          <Code>id</Code> passed to the form control will be passed to the input
          directly.
        </ListItem>
        <ListItem>
          <Code>FormLabel</Code> will have <Code>for</Code> pointing to the{" "}
          <Code>id</Code> of the input.
        </ListItem>
        <ListItem>
          The input will have <Code>aria-describedby</Code> pointing to the{" "}
          <Code>id</Code> of the <Code>FormHelperText</Code>.
        </ListItem>
        <ListItem>
          When the field is invalid, the input will have{" "}
          <Code>aria-invalid</Code> set to <Code>true</Code> and{" "}
          <Code>aria-describedby</Code> pointing to the <Code>id</Code> of the{" "}
          <Code>FormErrorMessage</Code> first.
        </ListItem>
        <ListItem>
          <Code>required</Code>, <Code>disabled</Code>, <Code>invalid</Code> and{" "}
          <Code>readOnly</Code> props passed to <Code>FormControl</Code> will
          cascade across all related components.
        </ListItem>
      </UnorderedList>
      <UnorderedList spacing="$2" mb="$12">
        <ListItem>
          <Code>FormLabel</Code> is aware of the <Code>disabled</Code>,{" "}
          <Code>focused</Code> and <Code>invalid</Code> state of the input. This
          helps you style the label accordingly using the <Code>_disabled</Code>
          , <Code>_focus</Code>, and <Code>_invalid</Code> style props.
        </ListItem>
        <ListItem>
          <Code>FormErrorMessage</Code> only renders if <Code>invalid</Code> is
          set to <Code>true</Code>.
        </ListItem>
      </UnorderedList>
      <SectionTitle id="theming">Theming</SectionTitle>
      <Text mb="$5">
        <Code>FormControl</Code> base styles and default props can be overridden
