import { Text, Textarea, VStack } from "@incmix/ui";
...
export default function TextareaDoc() {
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        The <Code>Textarea</Code> component allows you to easily create
        multi-line text textareas.
      </Text>
      ...
      <Text mb="$5">
        Use the <Code>size</Code> prop to change the size of the Textarea's
        text. You can set the value to <Code>xs</Code>, <Code>sm</Code>,{" "}
      ...
      <Text mb="$5">
        ...
        Textarea. You can set the value to <Code>outline</Code>,{" "}
      ...
      <Text mb="$5">
        <Code>Textarea</Code> base styles and default props can be overridden in
