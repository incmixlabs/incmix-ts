...
export default function CheckboxDoc() {
  ...
  const contextualNavLinks: ContextualNavLink[] = [
    ...
    { href: "#variants", label: "Checkbox variants", indent: true },
    {
      ...
      label: "Checkbox label placement",
      indent: true,
    },
    ...
    {
      href: "#checkbox-primitive-props",
      label: "CheckboxPrimitive props",
      indent: true,
    },
    { href: "#checkbox-props", label: "Checkbox props", indent: true },
    {
      href: "#checkbox-group-props",
      label: "CheckboxGroup props",
      indent: true,
    },
  ];
  ...
  const checkboxPrimitivePropItems: PropsTableItem[] = [
    ...
    },
    {
      name: "invalid",
      description:
        "If `true`, the checkbox will have `aria-invalid` set to `true`.",
      type: "boolean",
    },
    {
      name: "readOnly",
  ...
  const checkboxPropItems: PropsTableItem[] = [
    ...
    },
    {
      ...
      description:
        "The icon to use when the checkbox is in indeterminate state.",
      type: "JSX.Element",
    },
    {
      name: "children",
  ...
  const checkboxGroupPropItems: PropsTableItem[] = [
    ...
    },
    {
      name: "defaultValue",
      description:
        "The initial value of the checkbox group (in uncontrolled mode).",
      type: "(string | number)[]",
    },
    {
      name: "required",
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        The <Code>Checkbox</Code> component is used in forms when a user needs
        to select multiple values from several options.
      </Text>
      <SectionTitle id="import">Import</SectionTitle>
      <CodeSnippet snippet={snippets.importComponent} mb="$6" />
      <UnorderedList spacing="$2" mb="$12">
        <ListItem>
          <strong>CheckboxPrimitive:</strong> Unstyled component containing all
          the parts of a checkbox. It renders a <Code>label</Code> and a visualy
          hidden <Code>input</Code> with type set to <Code>checkbox</Code>.
        </ListItem>
        <ListItem>
          <strong>CheckboxPrimitiveIndicator:</strong> Unstyled component
          rendered when the <Code>CheckboxPrimitive</Code> is in a{" "}
          <Code>checked</Code> or <Code>indeterminate</Code> state.
        </ListItem>
        <ListItem>
          <strong>Checkbox:</strong> The Hope UI styled checkbox component based
          on <Code>CheckboxPrimitive</Code>.
        </ListItem>
        <ListItem>
          <strong>CheckboxGroup:</strong> Component to help manage the checked
          state of its children <Code>Checkbox</Code> components and
          conveniently pass a few shared style props to each.
        </ListItem>
      </UnorderedList>
      ...
      <Text mb="$5">
        ...
        Checkbox. You can set the value to <Code>primary</Code>,{" "}
      ...
      <Text mb="$5">
        Use the <Code>size</Code> prop to change the size of the Checkbox. You
        can set the value to <Code>sm</Code>, <Code>md</Code> or <Code>lg</Code>
        .
      </Text>
      ...
      <Text mb="$5">
        ...
        Checkbox. You can set the value to <Code>outline</Code> or{" "}
        <Code>filled</Code>.
      </Text>
      ...
      <SectionSubtitle id="label-placement">
        Checkbox label placement
      </SectionSubtitle>
      <Text mb="$5">
        Use the <Code>labelPlacement</Code> prop to change the placement of the
        label. You can set the value to <Code>start</Code> or <Code>end</Code>.
      </Text>
      ...
      <Text mb="$5">
        Use the <Code>indeterminate</Code> prop to mark the Checkbox as
        indeterminate.
      </Text>
      ...
      <Text mb="$5">
        Use the <Code>iconChecked</Code> and <Code>iconIndeterminate</Code> prop
        on <Code>CheckboxControl</Code> to change the Checkbox icon.
      </Text>
      ...
      <Text mb="$5">
        You can use the <Code>CheckboxGroup</Code> component to manage the
        checked state of related <Code>Checkbox</Code> components and
        conveniently pass a few shared style props to each. See the props table
        at the bottom of this page for a list of the shared styling props.
      </Text>
      ...
      <Text mb="$5">
        Use the unstyled <Code>CheckboxPrimitive</Code> component to achieve
        your desired design. You can pair it with your styling solution of
        choice. The below example uses style props and the <Code>css</Code>{" "}
        function.
      </Text>
      ...
      <Text mb="$5">
        <Code>Checkbox</Code> base styles and default props can be overridden in
        the Hope UI theme configuration like below:
      </Text>
      <CodeSnippet lang="js" snippet={snippets.theming} mb="$12" />
      <SectionTitle id="props">Props</SectionTitle>
      <SectionSubtitle id="checkbox-primitive-props">
      ...
      <Text mb="$5">
        <Code>Checkbox</Code> composes the <Code>CheckboxPrimitive</Code>{" "}
        component, so you can pass all its props. These are props specific to
        the <Code>Checkbox</Code> component:
      </Text>
      <PropsTable items={checkboxPropItems} mb="$10" />
      <SectionSubtitle id="checkbox-group-props">
        CheckboxGroup props
      </SectionSubtitle>
