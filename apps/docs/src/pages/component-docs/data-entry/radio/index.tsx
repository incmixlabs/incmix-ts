...
export default function RadioDoc() {
  ...
  const radioPropItems: PropsTableItem[] = [
    ...
    },
    {
      name: "invalid",
      description:
        "If `true`, the radio will have `aria-invalid` set to `true`.",
      type: "boolean",
    },
    {
      name: "readOnly",
  ...
  return (
    ...
    >
      ...
      <UnorderedList spacing="$2" mb="$12">
        <ListItem>
          <strong>Radio:</strong> Provides context for all its children. It
          renders a <Code>label</Code> and a visualy hidden <Code>input</Code>{" "}
          with type set to <Code>radio</Code>.
        </ListItem>
        <ListItem>
          <strong>RadioGroup:</strong> Component to help manage the checked
          state of its children <Code>Radio</Code> components and conveniently
          pass a few shared style props to each.
        </ListItem>
      </UnorderedList>
      ...
      <Text mb="$5">
        Use the <Code>colorScheme</Code> prop to change the color of the Radio.
      ...
      <Text mb="$5">
        Use the <Code>size</Code> prop to change the size of the Radio. You can
      ...
      <Text mb="$5">
        ...
        Radio. You can set the value to <Code>outline</Code> or{" "}
        <Code>filled</Code>.
      </Text>
      ...
      <Text mb="$5">
        We recommend passing the <Code>name</Code> prop to the{" "}
        <Code>RadioGroup</Code> component, instead of passing it to each{" "}
        <Code>Radio</Code> component. By default, the <Code>name</Code> prop of
        the <Code>RadioGroup</Code> takes precedence.
      </Text>
      <CodeSnippet snippet={snippets.nameProp} mb="$12" />
      <SectionTitle id="theming">Theming</SectionTitle>
      <Text mb="$5">
        <Code>Radio</Code> base styles and default props can be overridden in
