import { HStack, IconButton, incmix, Text } from "@incmix/ui";
...
export default function IconButtonDoc() {
  ...
  return (
    ...
    >
      ...
      <Text mb="$8">
        IconButton composes the <Code>Button</Code> component except that it
        renders only an icon.
      </Text>
      ...
      <Text mb="$5">
        The <Code>IconButton</Code> component accepts most of the props from the{" "}
        <Code>Button</Code> component, so we can use <Code>colorScheme</Code>{" "}
      ...
      <Text mb="$5">
        Like the <Code>Button</Code> component, pass the <Code>size</Code> prop
      ...
      <Text mb="$5">
        Like the <Code>Button</Code> component, pass the <Code>variant</Code>{" "}
        prop to change the style of the button.
      </Text>
      ...
      <Text mb="$5">
        <Code>IconButton</Code> base styles and default props can be overridden
