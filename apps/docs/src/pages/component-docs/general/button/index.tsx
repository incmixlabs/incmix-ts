...
export default function ButtonDoc() {
  ...
  const buttonPropItems: PropsTableItem[] = [
    ...
    },
    {
      ...
      description:
        "Determines the placement of the loader when `loading` is `true`.",
      type: '"start" | "end"',
      defaultValue: '"start"',
    },
    {
  ...
  return (
    ...
    >
      ...
      <Text mb="$5">
        Use the <Code>colorScheme</Code> prop to change the color of the Button.
      ...
      <Text mb="$5">
        ...
        set the value to <Code>xs</Code>, <Code>sm</Code>, <Code>md</Code>,{" "}
        <Code>lg</Code> or <Code>xl</Code>.
      </Text>
      ...
      <Text mb="$5">
        ...
        Button. You can set the value to <Code>solid</Code>, <Code>subtle</Code>
        , <Code>outline</Code>, <Code>dashed</Code> or <Code>ghost</Code>.
      </Text>
      ...
      <Alert status="warning" mb="$5">
        <AlertDescription>
          The <Code>leftIcon</Code> and <Code>rightIcon</Code> prop values
          should be jsx elements not strings.
        </AlertDescription>
      </Alert>
      ...
      <SectionSubtitle id="button-loading-state">
        Button loading state
      </SectionSubtitle>
      <Text mb="$5">
        Pass the <Code>loading</Code> prop to show its loading state. By
        default, the button will show a spinner and leave the button's width
        unchanged. You can also pass the <Code>loadingText</Code> prop to show a
      ...
      <Text mb="$5">
        You can change the loader element to use custom loaders as per your
        design requirements. Pass the <Code>loader</Code> prop and set it to a
        custom jsx element.
      </Text>
      ...
      <Text mb="$5">
        When a <Code>loaderText</Code> is present, you can change the placement
        of the loader element to either <Code>start</Code> or <Code>end</Code>.
      </Text>
      ...
      <Text mb="$3">
        ...
        to group buttons. When you use the <Code>ButtonGroup</Code> component,
        it allows you to:
      </Text>
      <UnorderedList spacing="$2" mb="$5">
        <ListItem>
          Set the <Code>variant</Code>, <Code>colorScheme</Code>,{" "}
          <Code>size</Code> and <Code>disabled</Code> state of all buttons
          within it.
        </ListItem>
        <ListItem>
        ...
        <ListItem>
          Flush the buttons together by removing the border radius of its
          children as needed.
        </ListItem>
      </UnorderedList>
      ...
      <Text mb="$5">
        You can override any style of the Button via style props.
      </Text>
      ...
      <Text mb="$5">
        <Code>Button</Code> base styles and default props can be overridden in
      ...
      <SectionSubtitle id="button-group-props">
        ButtonGroup props
      </SectionSubtitle>
